    ...
    !function(t, e) {
      ...
      function d() {
        if (this.dimensionsToTest = 2, 0 === arguments.length) d.call(this, 2);
          ...
          var t2 = arguments[0];
          if (2 !== t2 && 3 !== t2) throw new i2("only 2 or 3 dimensions may be specified");
      ...
      function ft() {
        ...
        if (B.call(this, e2), null === t2 && (t2 = []), B.hasNullElements(t2)) throw new i2("geometries must not contain null elements");
        this.geometries = t2;
      }
      function gt() {
        var t2 = arguments[0], e2 = arguments[1];
      ...
      function Tt() {
        ...
        if (B.call(this, n2), null === t2 && (t2 = this.getFactory().createLinearRing()), null === e2 && (e2 = []), B.hasNullElements(e2)) throw new i2("holes must not contain null elements");
        if (t2.isEmpty() && B.hasNonEmptyElements(e2)) throw new i2("shell is empty but holes are not");
      ...
      function Gt() {
        if (this.dimension = 3, this.coordinates = null, 1 === arguments.length) {
          if (arguments[0] instanceof Array) {
            ...
            for (var n2 = 0; e2 > n2; n2++) this.coordinates[n2] = new g();
          } else if (R(arguments[0], D)) {
            var i3 = arguments[0];
            if (null === i3) return this.coordinates = new Array(0).fill(null), null;
            this.dimension = i3.getDimension(), this.coordinates = new Array(i3.size()).fill(null);
            for (var n2 = 0; n2 < this.coordinates.length; n2++) this.coordinates[n2] = i3.getCoordinateCopy(n2);
          }
        } else if (2 === arguments.length) {
          if (arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
            ...
            for (var n2 = 0; o2 > n2; n2++) this.coordinates[n2] = new g();
          }
        }
      }
      function qt() {
      ...
      function Ut(t2, e2) {
        if (this.objectOnly && e2 !== Object(e2)) throw new TypeError("Invalid value used as weak collection key");
        if (e2 !== e2 || 0 === e2) for (no = t2.length; no-- && !Bt(t2[no], e2); ) ;
        else no = t2.indexOf(e2);
        return no > -1;
      }
      function Xt(t2) {
      ...
      function Te() {
        if (this.boundaryRule = V.OGC_SFS_BOUNDARY_RULE, this.isIn = null, this.numBoundaries = null, 0 === arguments.length) ;
          ...
          var t2 = arguments[0];
          if (null === t2) throw new i2("Rule must be non-null");
      ...
      function Be() {
        if (this.root = null, this.built = false, this.itemBoundables = new I(), this.nodeCapacity = null, 0 === arguments.length) Be.call(this, Be.DEFAULT_NODE_CAPACITY);
        else if (1 === arguments.length) {
          var t2 = arguments[0];
      ...
      function fn() {
        if (this.location = null, 1 === arguments.length) {
          if (arguments[0] instanceof Array) {
            ...
            var n2 = arguments[0];
            if (this.init(n2.location.length), null !== n2) for (var i3 = 0; i3 < this.location.length; i3++) this.location[i3] = n2.location[i3];
          }
        } else if (3 === arguments.length) {
          var r2 = arguments[0], s2 = arguments[1], o2 = arguments[2];
      ...
      function In() {
        ...
        var t2 = arguments[0], e2 = arguments[1];
        if (En.call(this, t2), this._isForward = e2, e2) this.init(t2.getCoordinate(0), t2.getCoordinate(1));
        else {
      ...
      function Un() {
        this.index = null;
        var t2 = arguments[0];
        if (!R(t2, Rt)) throw new i2("Argument must be Polygonal");
      ...
      function Qn() {
        ...
        for (var t2 = 0; 2 > t2; t2++) for (var e2 = 0; 3 > e2; e2++) this.depth[t2][e2] = Qn.NULL_VALUE;
      }
      function Jn() {
      ...
      function Si(t2, e2) {
        ...
        if (s2 || (n2 = 0 > e2 || 0 > 1 / e2, isFinite(e2) || (s2 = o2[t2], n2 && (s2.d += 1 << t2 / 4 - 1), i3 = Math.pow(2, a2) - 1, r2 = 0)), !s2) {
          for (i3 = { 32: 127, 64: 1023 }[t2], r2 = Math.abs(e2); r2 >= 2; ) i3++, r2 /= 2;
          for (; 1 > r2 && i3 > 0; ) i3--, r2 *= 2;
      ...
      function $i() {
        ...
        var t2 = arguments[0], e2 = arguments[1], n2 = arguments[2];
        if (this.originalPt = t2, this.pt = t2, this.scaleFactor = e2, this.li = n2, 0 >= e2) throw new i2("Scale factor must be non-zero");
      ...
      function Tr() {
        if (this.lineStringAdder = new Pr(this), this.graph = null, this.dangles = new I(), this.cutEdges = new I(), this.invalidRingLines = new I(), this.holeList = null, this.shellList = null, this.polyList = null, this.isCheckingRingsValid = true, this.extractOnlyPolygonal = null, this.geomFactory = null, 0 === arguments.length) Tr.call(this, false);
        else if (1 === arguments.length) {
          var t2 = arguments[0];
      ...
      Array.prototype.fill || (Array.prototype.fill = function(t2) {
        for (var e2 = Object(this), n2 = parseInt(e2.length, 10), i3 = arguments[1], r2 = parseInt(i3, 10) || 0, s2 = 0 > r2 ? Math.max(n2 + r2, 0) : Math.min(r2, n2), o2 = arguments[2], a2 = void 0 === o2 ? n2 : parseInt(o2, 10) || 0, u2 = 0 > a2 ? Math.max(n2 + a2, 0) : Math.min(a2, n2); u2 > s2; s2++) e2[s2] = t2;
        return e2;
        ...
        if (1 === arguments.length) {
          ...
          var e2 = arguments[0], n2 = arguments[1];
          if (!e2) throw null === n2 ? new c() : new c(n2);
        }
      }, f.equals = function() {
        if (2 === arguments.length) {
          ...
          var n2 = arguments[0], i3 = arguments[1], r2 = arguments[2];
          if (!i3.equals(n2)) throw new c("Expected " + n2 + " but encountered " + i3 + (null !== r2 ? ": " + r2 : ""));
        }
        ...
        try {
          ...
          if (t3 instanceof CloneNotSupportedException) return f.shouldNeverReachHere("this shouldn't happen because this class is Cloneable"), null;
          throw t3;
        } finally {
        }
      }, copy: function() {
        ...
        if (0 > t2 || t2 >= this.size()) throw new m();
        ...
        for (var t2 = [], e2 = 0, n2 = this.array_.length; n2 > e2; e2++) t2.push(this.array_[e2]);
        return t2;
      }, I.prototype.remove = function(t2) {
        for (var e2 = false, n2 = 0, i3 = this.array_.length; i3 > n2; n2++) if (this.array_[n2] === t2) {
      ...
      Qs.prototype.next = function() {
        ...
        if (2 === arguments.length) {
          for (var t2 = arguments[0], e2 = arguments[1], n2 = false, i3 = t2.iterator(); i3.hasNext(); ) this.add(i3.next(), e2), n2 = true;
          return n2;
        }
        return I.prototype.addAll.apply(this, arguments);
      }, clone: function t2() {
        for (var t3 = I.prototype.clone.call(this), e2 = 0; e2 < this.size(); e2++) t3.add(e2, this.get(e2).copy());
        return t3;
        ...
        if (1 === arguments.length) {
          ...
          if ("boolean" == typeof arguments[2] && arguments[0] instanceof Array && "boolean" == typeof arguments[1]) {
            ...
            if (h2) for (var c2 = 0; c2 < u2.length; c2++) this.add(u2[c2], l2);
            else for (var c2 = u2.length - 1; c2 >= 0; c2--) this.add(u2[c2], l2);
            return true;
          }
            ...
            if (!p2) {
              ...
              if (v2 > 0) {
                if (f2 > 0) {
                  ...
                  if (m2.equals2D(d2)) return null;
                }
                if (v2 > f2) {
                  var y2 = this.get(f2);
                  if (y2.equals2D(d2)) return null;
                }
              }
            }
          ...
          N2 > C2 && (S2 = -1);
          for (var c2 = N2; c2 !== C2; c2 += S2) this.add(x2[c2], E2);
          return true;
        }
      }, closeRing: function() {
        ...
        if (this.isNull() || t2.isNull() || !this.intersects(t2)) return new C();
        ...
        for (var s2 = i3 + 1, o2 = new P(), a2 = _.MAX_PRINT_DIGITS - 1, u2 = 0; a2 >= u2; u2++) {
          ...
          if (0 > g2 && Math.abs(g2) >= a2 - u2 && (f2 = false), !f2) break;
        }
        ...
        if (0 === t2) return _.valueOf(1);
        var e2 = new _(this), n2 = _.valueOf(1), i3 = Math.abs(t2);
        if (i3 > 1) for (; i3 > 0; ) i3 % 2 === 1 && n2.selfMultiply(e2), i3 /= 2, i3 > 0 && (e2 = e2.sqr());
        else n2 = e2;
        ...
        if ("." === n2.charAt(0)) r2 = "0" + n2;
        else if (0 > i3) r2 = "0." + _.stringOfChar("0", -i3) + n2;
        ...
        for (var e2 = 0, n2 = t2.length; O.isWhitespace(t2.charAt(e2)); ) e2++;
        var i3 = false;
        if (n2 > e2) {
          var r2 = t2.charAt(e2);
          "-" !== r2 && "+" !== r2 || (e2++, "-" === r2 && (i3 = true));
        ...
        for (var n2 = new P(), i3 = 0; e2 > i3; i3++) n2.append(t2);
        return n2.toString();
        ...
        if (r2 > 0) {
          if (0 >= s2) return M.signum(o2);
          i3 = r2 + s2;
        } else {
          if (!(0 > r2)) return M.signum(o2);
          if (s2 >= 0) return M.signum(o2);
          i3 = -r2 - s2;
        }
        ...
        for (var s2 = 0, o2 = e2; e2 + r2 > o2; o2++) n2[i3 + s2] = t2[o2], s2++;
      }, A.getProperty = function(t2) {
        return { "line.separator": "\n" }[t2];
      }, e(F.prototype, { getY: function() {
        var t2 = this.y / this.w;
        if (r.isNaN(t2) || r.isInfinite(t2)) throw new w();
        return t2;
      }, getX: function() {
        ...
        if (r.isNaN(p2) || r.isInfinite(p2) || r.isNaN(v2) || r.isInfinite(v2)) throw new w();
        return new g(p2, v2);
        ...
        if (1 === arguments.length) {
          ...
          if (arguments[0] instanceof Object) {
            var e2 = arguments[0];
            if (!(e2 instanceof B)) return false;
            var n2 = e2;
        ...
        if (t2.getSortIndex() === B.SORTINDEX_GEOMETRYCOLLECTION) throw new i2("This method does not support GeometryCollection arguments");
        ...
        for (var e2 = 0; e2 < t2.length; e2++) if (!t2[e2].isEmpty()) return true;
        return false;
      }, B.hasNullElements = function(t2) {
        for (var e2 = 0; e2 < t2.length; e2++) if (null === t2[e2]) return true;
        return false;
        ...
        for (var n2 = 0; n2 < t2.length; n2++) {
          var i3 = t2[n2];
          if (H.indexOf(i3, e2) < 0) return i3;
        }
        return null;
        ...
        if (2 === arguments.length) {
          ...
          for (var n2 = 0; n2 < t2.length; n2++) if (!t2[n2].equals(e2[n2])) return false;
          return true;
        }
        if (3 === arguments.length) {
          var i3 = arguments[0], r2 = arguments[1], s2 = arguments[2];
          if (i3 === r2) return true;
          if (null === i3 || null === r2) return false;
          if (i3.length !== r2.length) return false;
          for (var n2 = 0; n2 < i3.length; n2++) if (0 !== s2.compare(i3[n2], r2[n2])) return false;
          return true;
        }
      }, H.intersection = function(t2, e2) {
        for (var n2 = new N(), i3 = 0; i3 < t2.length; i3++) e2.intersects(t2[i3]) && n2.add(t2[i3], true);
        return n2.toCoordinateArray();
      }, H.hasRepeatedPoints = function(t2) {
        for (var e2 = 1; e2 < t2.length; e2++) if (t2[e2 - 1].equals(t2[e2])) return true;
        return false;
      }, H.removeRepeatedPoints = function(t2) {
        if (!H.hasRepeatedPoints(t2)) return t2;
        ...
        for (var e2 = 0, n2 = 0; n2 < t2.length; n2++) null !== t2[n2] && e2++;
        var i3 = new Array(e2).fill(null);
        if (0 === e2) return i3;
        for (var r2 = 0, n2 = 0; n2 < t2.length; n2++) null !== t2[n2] && (i3[r2++] = t2[n2]);
        return i3;
      }, H.copyDeep = function() {
        if (1 === arguments.length) {
          for (var t2 = arguments[0], e2 = new Array(t2.length).fill(null), n2 = 0; n2 < t2.length; n2++) e2[n2] = new g(t2[n2]);
          return e2;
        }
        if (5 === arguments.length) for (var i3 = arguments[0], r2 = arguments[1], s2 = arguments[2], o2 = arguments[3], a2 = arguments[4], n2 = 0; a2 > n2; n2++) s2[o2 + n2] = new g(i3[r2 + n2]);
      }, H.isEqualReversed = function(t2, e2) {
        for (var n2 = 0; n2 < t2.length; n2++) {
          var i3 = t2[n2], r2 = e2[t2.length - n2 - 1];
          if (0 !== i3.compareTo(r2)) return false;
        }
        return true;
      }, H.envelope = function(t2) {
        for (var e2 = new C(), n2 = 0; n2 < t2.length; n2++) e2.expandToInclude(t2[n2]);
        return e2;
        ...
        for (var n2 = 0; n2 < e2.length; n2++) if (t2.equals(e2[n2])) return n2;
        return -1;
        ...
        for (var e2 = null, n2 = 0; n2 < t2.length; n2++) (null === e2 || e2.compareTo(t2[n2]) > 0) && (e2 = t2[n2]);
        return e2;
        ...
        if (0 === i3) return r2;
        for (var s2 = 0, o2 = e2; n2 >= o2; o2++) r2[s2++] = t2[o2];
        return r2;
        ...
        var n2 = t2, i3 = e2;
        if (n2.length < i3.length) return -1;
        if (n2.length > i3.length) return 1;
      ...
      rt.prototype = new Z(), rt.prototype.get = function(t2) {
        ...
        if (null === this.root_) return this.root_ = { key: t2, value: e2, left: null, right: null, parent: null, color: $s, getValue: function() {
          return this.value;
        }, getKey: function() {
          return this.key;
        } }, this.size_ = 1, null;
        ...
        do
          if (n2 = r2, i3 = t2.compareTo(r2.key), 0 > i3) r2 = r2.left;
          else {
            if (!(i3 > 0)) {
              var s2 = r2.value;
        ...
        for (t2.color = to; null != t2 && t2 != this.root_ && t2.parent.color == to; ) if (tt(t2) == nt(tt(tt(t2)))) {
          var e2 = it(tt(tt(t2)));
        ...
        if (null !== t2.right) {
          for (var e2 = t2.right; null !== e2.left; ) e2 = e2.left;
          return e2;
        }
        for (var e2 = t2.parent, n2 = t2; null !== e2 && n2 === e2.right; ) n2 = e2, e2 = e2.parent;
        return e2;
        ...
        for (var e2 = 0, n2 = this.array_.length; n2 > e2; e2++) {
          var i3 = this.array_[e2];
          if (0 === i3.compareTo(t2)) return true;
        }
        return false;
        ...
        for (var e2 = 0, n2 = this.array_.length; n2 > e2; e2++) {
          var i3 = this.array_[e2];
          if (1 === i3.compareTo(t2)) return this.array_.splice(e2, 0, t2), true;
        }
        return this.array_.push(t2), true;
      ...
      eo.prototype.next = function() {
        ...
        if (1 === arguments.length) return i3 = function(t3, e3) {
          return t3.compareTo(e3);
        }, void r2.sort(i3);
        if (2 === arguments.length) n2 = arguments[1], i3 = function(t3, e3) {
          ...
          if (3 === arguments.length) {
            ...
            for (r2.splice(0, r2.length), t2 = 0; t2 < s2.length; t2++) r2.push(s2[t2]);
            return;
          }
          if (4 === arguments.length) {
            for (e2 = r2.slice(arguments[1], arguments[2]), n2 = arguments[3], i3 = function(t3, e3) {
              return n2.compare(t3, e3);
            }, e2.sort(i3), s2 = r2.slice(0, arguments[1]).concat(e2, r2.slice(arguments[2], r2.length)), r2.splice(0, r2.length), t2 = 0; t2 < s2.length; t2++) r2.push(s2[t2]);
            return;
          }
        }
      }, ut.asList = function(t2) {
        for (var e2 = new I(), n2 = 0, i3 = t2.length; i3 > n2; n2++) e2.add(t2[n2]);
        return e2;
        ...
        for (var t2 = new C(), e2 = 0; e2 < this.geometries.length; e2++) t2.expandToInclude(this.geometries[e2].getEnvelopeInternal());
        return t2;
      }, getGeometryN: function(t2) {
        ...
        for (var t2 = new Array(this.getNumPoints()).fill(null), e2 = -1, n2 = 0; n2 < this.geometries.length; n2++) for (var i3 = this.geometries[n2].getCoordinates(), r2 = 0; r2 < i3.length; r2++) e2++, t2[e2] = i3[r2];
        return t2;
      }, getArea: function() {
        for (var t2 = 0, e2 = 0; e2 < this.geometries.length; e2++) t2 += this.geometries[e2].getArea();
        return t2;
        ...
        if (2 === arguments.length) {
          ...
          var n2 = t2;
          if (this.geometries.length !== n2.geometries.length) return false;
          for (var i3 = 0; i3 < this.geometries.length; i3++) if (!this.geometries[i3].equalsExact(n2.geometries[i3], e2)) return false;
          return true;
        }
        return B.prototype.equalsExact.apply(this, arguments);
      }, normalize: function() {
        for (var t2 = 0; t2 < this.geometries.length; t2++) this.geometries[t2].normalize();
        ut.sort(this.geometries);
      }, getCoordinate: function() {
        return this.isEmpty() ? null : this.geometries[0].getCoordinate();
      }, getBoundaryDimension: function() {
        for (var t2 = lt.FALSE, e2 = 0; e2 < this.geometries.length; e2++) t2 = Math.max(t2, this.geometries[e2].getBoundaryDimension());
        return t2;
      }, getDimension: function() {
        for (var t2 = lt.FALSE, e2 = 0; e2 < this.geometries.length; e2++) t2 = Math.max(t2, this.geometries[e2].getDimension());
        return t2;
      }, getLength: function() {
        for (var t2 = 0, e2 = 0; e2 < this.geometries.length; e2++) t2 += this.geometries[e2].getLength();
        return t2;
      }, getNumPoints: function() {
        for (var t2 = 0, e2 = 0; e2 < this.geometries.length; e2++) t2 += this.geometries[e2].getNumPoints();
        return t2;
      }, getNumGeometries: function() {
        return this.geometries.length;
      }, reverse: function() {
        for (var t2 = this.geometries.length, e2 = new Array(t2).fill(null), n2 = 0; n2 < this.geometries.length; n2++) e2[n2] = this.geometries[n2].reverse();
        ...
        if (R(arguments[0], z)) for (var t2 = arguments[0], e2 = 0; e2 < this.geometries.length; e2++) this.geometries[e2].apply(t2);
          ...
          var i3 = arguments[0];
          i3.filter(this);
          for (var e2 = 0; e2 < this.geometries.length; e2++) this.geometries[e2].apply(i3);
        } else if (R(arguments[0], q)) {
          var r2 = arguments[0];
          r2.filter(this);
          for (var e2 = 0; e2 < this.geometries.length; e2++) this.geometries[e2].apply(r2);
        }
        ...
        for (var e2 = 0; e2 < this.geometries.length; e2++) t2.geometries[e2] = this.geometries[e2].clone();
        return t2;
      }, getGeometryType: function() {
        return "GeometryCollection";
      }, copy: function() {
        for (var t2 = new Array(this.geometries.length).fill(null), e2 = 0; e2 < t2.length; e2++) t2[e2] = this.geometries[e2].copy();
        return new ft(t2, this.factory);
      }, isEmpty: function() {
        for (var t2 = 0; t2 < this.geometries.length; t2++) if (!this.geometries[t2].isEmpty()) return false;
        return true;
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        ...
        for (var t2 = 0; t2 < this.geometries.length; t2++) if (!this.geometries[t2].isClosed()) return false;
        return true;
      }, getDimension: function() {
        return 1;
      }, reverse: function() {
        for (var t2 = this.geometries.length, e2 = new Array(t2).fill(null), n2 = 0; n2 < this.geometries.length; n2++) e2[t2 - 1 - n2] = this.geometries[n2].reverse();
        ...
        for (var n2 = new Array(e2).fill(null), i3 = 0; e2 > i3; i3++) n2[i3] = t2;
        ...
        if (2 === arguments.length) {
          for (var i3 = arguments[0], r2 = arguments[1], s2 = "", o2 = new mt(Nt.getStackTrace(i3)), a2 = new It(o2), u2 = 0; r2 > u2; u2++) try {
        ...
        for (var a2 = new Array(i3.size()).fill(null), u2 = 0; u2 < a2.length; u2++) a2[u2] = i3.get(u2);
        return a2;
        ...
        for (var r2 = Math.min(t2.getDimension(), n2.getDimension()), s2 = 0; r2 > s2; s2++) n2.setOrdinate(i3, s2, t2.getOrdinate(e2, s2));
        ...
        for (var s2 = Math.min(t2.getDimension(), e2.getDimension()), o2 = 0; n2 > o2; o2++) for (var a2 = 0; s2 > a2; a2++) {
          var u2 = t2.getOrdinate(o2, a2), l2 = e2.getOrdinate(o2, a2);
          if (!(t2.getOrdinate(o2, a2) === e2.getOrdinate(o2, a2) || r.isNaN(u2) && r.isNaN(l2))) return false;
        }
        return true;
      }, Ct.extend = function(t2, e2, n2) {
        var i3 = t2.create(n2, e2.getDimension()), r2 = e2.size();
        if (Ct.copy(e2, 0, i3, 0, r2), r2 > 0) for (var s2 = r2; n2 > s2; s2++) Ct.copy(e2, r2 - 1, i3, s2, 1);
        return i3;
      }, Ct.reverse = function(t2) {
        for (var e2 = t2.size() - 1, n2 = Math.trunc(e2 / 2), i3 = 0; n2 >= i3; i3++) Ct.swap(t2, i3, e2 - i3);
        ...
        for (var s2 = 0; r2 > s2; s2++) Ct.copyCoord(t2, e2 + s2, n2, i3 + s2);
        ...
        if (1 === arguments.length) {
          ...
          for (var r2 = 0; e2 > r2; r2++) {
            r2 > 0 && i3.append(" ");
            for (var s2 = 0; n2 > s2; s2++) s2 > 0 && i3.append(","), i3.append(Nt.toString(t2.getOrdinate(r2, s2)));
          }
        ...
        var n2 = e2.size();
        if (0 === n2) return e2;
        if (3 >= n2) return Ct.createClosedRing(t2, e2, 4);
        ...
        for (var s2 = r2; n2 > s2; s2++) Ct.copy(e2, 0, i3, s2, 1);
        return i3;
        ...
        if (2 === arguments.length) {
          ...
          if (!this.isEquivalentClass(t2)) return false;
          var n2 = t2;
          if (this.points.size() !== n2.points.size()) return false;
          for (var i3 = 0; i3 < this.points.size(); i3++) if (!this.equal(this.points.getCoordinate(i3), n2.points.getCoordinate(i3), e2)) return false;
          return true;
        }
        return B.prototype.equalsExact.apply(this, arguments);
      }, normalize: function() {
        for (var t2 = 0; t2 < Math.trunc(this.points.size() / 2); t2++) {
          ...
          if (!this.points.getCoordinate(t2).equals(this.points.getCoordinate(e2))) return this.points.getCoordinate(t2).compareTo(this.points.getCoordinate(e2)) > 0 && Ct.reverse(this.points), null;
        }
      }, getCoordinate: function() {
        ...
        if (R(arguments[0], z)) for (var t2 = arguments[0], e2 = 0; e2 < this.points.size(); e2++) t2.filter(this.points.getCoordinate(e2));
        else if (R(arguments[0], ct)) {
          var n2 = arguments[0];
        ...
        if (null === t2 && (t2 = this.getFactory().getCoordinateSequenceFactory().create([])), 1 === t2.size()) throw new i2("Invalid number of points in LineString (found " + t2.size() + " - must be 0 or >= 2)");
        this.points = t2;
      }, isCoordinate: function(t2) {
        for (var e2 = 0; e2 < this.points.size(); e2++) if (this.points.getCoordinate(e2).equals(t2)) return true;
        return false;
        ...
        for (var t2 = new Array(this.getNumPoints()).fill(null), e2 = -1, n2 = this.shell.getCoordinates(), i3 = 0; i3 < n2.length; i3++) e2++, t2[e2] = n2[i3];
        for (var r2 = 0; r2 < this.holes.length; r2++) for (var s2 = this.holes[r2].getCoordinates(), o2 = 0; o2 < s2.length; o2++) e2++, t2[e2] = s2[o2];
        return t2;
      }, getArea: function() {
        var t2 = 0;
        t2 += Math.abs(he.signedArea(this.shell.getCoordinateSequence()));
        for (var e2 = 0; e2 < this.holes.length; e2++) t2 -= Math.abs(he.signedArea(this.holes[e2].getCoordinateSequence()));
        return t2;
      }, isRectangle: function() {
        if (0 !== this.getNumInteriorRing()) return false;
        if (null === this.shell) return false;
        if (5 !== this.shell.getNumPoints()) return false;
        ...
        if (2 === arguments.length) {
          ...
          if (!i3.equalsExact(r2, e2)) return false;
          if (this.holes.length !== n2.holes.length) return false;
          for (var s2 = 0; s2 < this.holes.length; s2++) if (!this.holes[s2].equalsExact(n2.holes[s2], e2)) return false;
          return true;
        }
        return B.prototype.equalsExact.apply(this, arguments);
      }, normalize: function() {
        if (0 === arguments.length) {
          ...
          for (var t2 = 0; t2 < this.holes.length; t2++) this.normalize(this.holes[t2], false);
          ut.sort(this.holes);
        } else if (2 === arguments.length) {
          var e2 = arguments[0], n2 = arguments[1];
        ...
        for (var e2 = 0; e2 < this.holes.length; e2++) t2 += this.holes[e2].getLength();
        return t2;
      }, getNumPoints: function() {
        for (var t2 = this.shell.getNumPoints(), e2 = 0; e2 < this.holes.length; e2++) t2 += this.holes[e2].getNumPoints();
        return t2;
      }, reverse: function() {
        var t2 = this.copy();
        t2.shell = this.shell.copy().reverse(), t2.holes = new Array(this.holes.length).fill(null);
        for (var e2 = 0; e2 < this.holes.length; e2++) t2.holes[e2] = this.holes[e2].copy().reverse();
        return t2;
      }, convexHull: function() {
        ...
        if (R(arguments[0], z)) {
          var t2 = arguments[0];
          this.shell.apply(t2);
          for (var e2 = 0; e2 < this.holes.length; e2++) this.holes[e2].apply(t2);
        } else if (R(arguments[0], ct)) {
          var n2 = arguments[0];
          if (this.shell.apply(n2), !n2.isDone()) for (var e2 = 0; e2 < this.holes.length && (this.holes[e2].apply(n2), !n2.isDone()); e2++) ;
          n2.isGeometryChanged() && this.geometryChanged();
        } else if (R(arguments[0], ht)) {
          var i3 = arguments[0];
          i3.filter(this);
          ...
          for (var e2 = 0; e2 < this.holes.length; e2++) this.holes[e2].apply(r2);
        }
      }, getBoundary: function() {
        if (this.isEmpty()) return this.getFactory().createMultiLineString();
        var t2 = new Array(this.holes.length + 1).fill(null);
        t2[0] = this.shell;
        for (var e2 = 0; e2 < this.holes.length; e2++) t2[e2 + 1] = this.holes[e2];
        ...
        for (var e2 = 0; e2 < this.holes.length; e2++) t2.holes[e2] = this.holes[e2].clone();
        return t2;
      }, getGeometryType: function() {
        return "Polygon";
      }, copy: function() {
        for (var t2 = this.shell.copy(), e2 = new Array(this.holes.length).fill(null), n2 = 0; n2 < e2.length; n2++) e2[n2] = this.holes[n2].copy();
        ...
        if (!this.isEmpty() && !St.prototype.isClosed.call(this)) throw new i2("Points of LinearRing do not form a closed linestring");
        if (this.getCoordinateSequence().size() >= 1 && this.getCoordinateSequence().size() < bt.MINIMUM_VALID_SIZE) throw new i2("Invalid number of points in LinearRing (found " + this.getCoordinateSequence().size() + " - must be 0 or >= 4)");
      }, getGeometryType: function() {
        return "LinearRing";
      }, copy: function() {
        ...
        if (this.isEmpty()) return this.getFactory().createMultiLineString();
        for (var t2 = new I(), e2 = 0; e2 < this.geometries.length; e2++) for (var n2 = this.geometries[e2], i3 = n2.getBoundary(), r2 = 0; r2 < i3.getNumGeometries(); r2++) t2.add(i3.getGeometryN(r2));
        ...
        if (null === n2 && (n2 = this.factory.createPolygon(null)), n2.isEmpty()) return n2;
        var i3 = this.edit(n2.getExteriorRing(), e2);
        if (null === i3 || i3.isEmpty()) return this.factory.createPolygon();
        ...
        if (t2 instanceof bt) return e2.createLinearRing(this.editCoordinates(t2.getCoordinates(), t2));
        if (t2 instanceof St) return e2.createLineString(this.editCoordinates(t2.getCoordinates(), t2));
        if (t2 instanceof Lt) {
        ...
        for (var t2 = new Array(this.size()).fill(null), e2 = 0; e2 < this.coordinates.length; e2++) t2[e2] = this.coordinates[e2].clone();
        return new Gt(t2, this.dimension);
      }, expandEnvelope: function(t2) {
        for (var e2 = 0; e2 < this.coordinates.length; e2++) t2.expandToInclude(this.coordinates[e2]);
        return t2;
      }, copy: function() {
        for (var t2 = new Array(this.size()).fill(null), e2 = 0; e2 < this.coordinates.length; e2++) t2[e2] = this.coordinates[e2].copy();
        return new Gt(t2, this.dimension);
      }, toString: function() {
        if (this.coordinates.length > 0) {
          var t2 = new P(17 * this.coordinates.length);
          t2.append("("), t2.append(this.coordinates[0]);
          for (var e2 = 1; e2 < this.coordinates.length; e2++) t2.append(", "), t2.append(this.coordinates[e2]);
      ...
      te.prototype = new K(), te.prototype.get = function(t2) {
        ...
        for (var t2 = new I(), e2 = this.map_.values(), n2 = e2.next(); !n2.done; ) t2.add(n2.value), n2 = e2.next();
        return t2;
        ...
        if (n2 || i3) return this.createGeometryCollection(ie.toGeometryArray(t2));
        var a2 = t2.iterator().next(), u2 = t2.size() > 1;
        if (u2) {
          if (a2 instanceof Tt) return this.createMultiPolygon(ie.toPolygonArray(t2));
          if (a2 instanceof St) return this.createMultiLineString(ie.toLineStringArray(t2));
          if (a2 instanceof Lt) return this.createMultiPoint(ie.toPointArray(t2));
        ...
        if (1 === arguments.length) {
          ...
          if (R(arguments[0], D)) {
            var n2 = arguments[0];
            if (null === n2) return this.createMultiPoint(new Array(0).fill(null));
      ...
      e(re.prototype, { read: function(t2) {
        ...
        if (-1 !== t2.search("EMPTY") && (r2 = oo.emptyTypeStr.exec(t2), r2[2] = void 0), r2 && (n2 = r2[1].toLowerCase(), i3 = r2[2], uo[n2] && (e2 = uo[n2].apply(this, [i3]))), void 0 === e2) throw new Error("Could not parse WKT " + t2);
        return e2;
      }, write: function(t2) {
        return this.extractGeometry(t2);
      }, extractGeometry: function(t2) {
        var e2 = t2.getGeometryType().toLowerCase();
        if (!ao[e2]) return null;
      ...
      var ao = { coordinate: function(t2) {
        ...
        for (var e2 = [], n2 = 0, i3 = t2.geometries.length; i3 > n2; ++n2) e2.push("(" + ao.point.apply(this, [t2.geometries[n2]]) + ")");
        return e2.join(",");
      }, linestring: function(t2) {
        for (var e2 = [], n2 = 0, i3 = t2.points.coordinates.length; i3 > n2; ++n2) e2.push(ao.coordinate.apply(this, [t2.points.coordinates[n2]]));
        return e2.join(",");
      }, linearring: function(t2) {
        for (var e2 = [], n2 = 0, i3 = t2.points.coordinates.length; i3 > n2; ++n2) e2.push(ao.coordinate.apply(this, [t2.points.coordinates[n2]]));
        return e2.join(",");
      }, multilinestring: function(t2) {
        for (var e2 = [], n2 = 0, i3 = t2.geometries.length; i3 > n2; ++n2) e2.push("(" + ao.linestring.apply(this, [t2.geometries[n2]]) + ")");
        return e2.join(",");
      }, polygon: function(t2) {
        var e2 = [];
        e2.push("(" + ao.linestring.apply(this, [t2.shell]) + ")");
        for (var n2 = 0, i3 = t2.holes.length; i3 > n2; ++n2) e2.push("(" + ao.linestring.apply(this, [t2.holes[n2]]) + ")");
        return e2.join(",");
      }, multipolygon: function(t2) {
        for (var e2 = [], n2 = 0, i3 = t2.geometries.length; i3 > n2; ++n2) e2.push("(" + ao.polygon.apply(this, [t2.geometries[n2]]) + ")");
        return e2.join(",");
      }, geometrycollection: function(t2) {
        for (var e2 = [], n2 = 0, i3 = t2.geometries.length; i3 > n2; ++n2) e2.push(this.extractGeometry(t2.geometries[n2]));
        return e2.join(",");
      } }, uo = { point: function(t2) {
        if (void 0 === t2) return this.geometryFactory.createPoint();
        ...
        for (var e2, n2 = t2.trim().split(","), i3 = [], r2 = 0, s2 = n2.length; s2 > r2; ++r2) e2 = n2[r2].replace(oo.trimParens, "$1"), i3.push(uo.point.apply(this, [e2]));
        return this.geometryFactory.createMultiPoint(i3);
      }, linestring: function(t2) {
        if (void 0 === t2) return this.geometryFactory.createLineString();
        for (var e2, n2 = t2.trim().split(","), i3 = [], r2 = 0, s2 = n2.length; s2 > r2; ++r2) e2 = n2[r2].trim().split(oo.spaces), i3.push(new g(Number.parseFloat(e2[0]), Number.parseFloat(e2[1])));
        ...
        for (var e2, n2 = t2.trim().split(oo.parenComma), i3 = [], r2 = 0, s2 = n2.length; s2 > r2; ++r2) e2 = n2[r2].replace(oo.trimParens, "$1"), i3.push(uo.linestring.apply(this, [e2]));
        return this.geometryFactory.createMultiLineString(i3);
      }, polygon: function(t2) {
        if (void 0 === t2) return this.geometryFactory.createPolygon();
        for (var e2, n2, i3, r2, s2 = t2.trim().split(oo.parenComma), o2 = [], a2 = 0, u2 = s2.length; u2 > a2; ++a2) e2 = s2[a2].replace(oo.trimParens, "$1"), n2 = uo.linestring.apply(this, [e2]), i3 = this.geometryFactory.createLinearRing(n2.points), 0 === a2 ? r2 = i3 : o2.push(i3);
        return this.geometryFactory.createPolygon(r2, o2);
      }, multipolygon: function(t2) {
        if (void 0 === t2) return this.geometryFactory.createMultiPolygon();
        for (var e2, n2 = t2.trim().split(oo.doubleParenComma), i3 = [], r2 = 0, s2 = n2.length; s2 > r2; ++r2) e2 = n2[r2].replace(oo.trimParens, "$1"), i3.push(uo.polygon.apply(this, [e2]));
        ...
        for (var e2 = t2.trim().split("|"), n2 = [], i3 = 0, r2 = e2.length; r2 > i3; ++i3) n2.push(this.read(e2[i3]));
      ...
      e(se.prototype, { write: function(t2) {
        ...
        if (0 === arguments.length) return this.isInteriorIntersection(0) ? true : !!this.isInteriorIntersection(1);
        if (1 === arguments.length) {
          for (var t2 = arguments[0], e2 = 0; e2 < this.result; e2++) if (!this.intPt[e2].equals2D(this.inputLines[t2][0]) && !this.intPt[e2].equals2D(this.inputLines[t2][1])) return true;
          return false;
        }
        ...
        for (var e2 = 0; e2 < this.result; e2++) if (this.intPt[e2].equals2D(t2)) return true;
        return false;
        ...
        if (t2.equals(e2)) s2 = 0;
        else if (t2.equals(n2)) s2 = i3 > r2 ? i3 : r2;
        else {
        ...
        if (this._isProper = false, !C.intersects(t2, e2, n2, i3)) return oe.NO_INTERSECTION;
        var r2 = he.orientationIndex(t2, e2, n2), s2 = he.orientationIndex(t2, e2, i3);
        if (r2 > 0 && s2 > 0 || 0 > r2 && 0 > s2) return oe.NO_INTERSECTION;
        var o2 = he.orientationIndex(n2, i3, t2), a2 = he.orientationIndex(n2, i3, e2);
        if (o2 > 0 && a2 > 0 || 0 > o2 && 0 > a2) return oe.NO_INTERSECTION;
        ...
        if (r2 = 1, 0 === t2 || 0 === i3) return 0 === e2 || 0 === n2 ? 0 : e2 > 0 ? n2 > 0 ? -r2 : r2 : n2 > 0 ? r2 : -r2;
        if (0 === e2 || 0 === n2) return i3 > 0 ? t2 > 0 ? r2 : -r2 : t2 > 0 ? -r2 : r2;
        ...
        for (; ; ) {
          if (a2 += 1, o2 = Math.floor(n2 / t2), n2 -= o2 * t2, i3 -= o2 * e2, 0 > i3) return -r2;
          if (i3 > e2) return r2;
          if (t2 > n2 + n2) {
            if (i3 + i3 > e2) return r2;
          } else {
            if (e2 > i3 + i3) return -r2;
            n2 = t2 - n2, i3 = e2 - i3, r2 = -r2;
          }
          if (0 === i3) return 0 === n2 ? 0 : -r2;
          if (0 === n2) return r2;
          if (o2 = Math.floor(t2 / n2), t2 -= o2 * n2, e2 -= o2 * i3, 0 > e2) return r2;
          if (e2 > i3) return -r2;
          if (n2 > t2 + t2) {
            if (e2 + e2 > i3) return -r2;
          } else {
            if (i3 > e2 + e2) return r2;
            t2 = n2 - t2, e2 = i3 - e2, r2 = -r2;
          }
          if (0 === e2) return 0 === t2 ? 0 : r2;
          if (0 === t2) return -r2;
        }
      }, e(le.prototype, { countSegment: function(t2, e2) {
        if (t2.x < this.p.x && e2.x < this.p.x) return null;
        if (this.p.x === e2.x && this.p.y === e2.y) return this.isPointOnSegment = true, null;
        ...
        if (t2.y > this.p.y && e2.y <= this.p.y || e2.y > this.p.y && t2.y <= this.p.y) {
          ...
          if (0 === u2) return this.isPointOnSegment = true, null;
        ...
        if (arguments[0] instanceof g && R(arguments[1], D)) {
          for (var t2 = arguments[0], e2 = arguments[1], n2 = new le(t2), i3 = new g(), r2 = new g(), s2 = 1; s2 < e2.size(); s2++) if (e2.getCoordinate(s2, i3), e2.getCoordinate(s2 - 1, r2), n2.countSegment(i3, r2), n2.isOnSegment()) return n2.getLocation();
        ...
        if (arguments[0] instanceof g && arguments[1] instanceof Array) {
          for (var o2 = arguments[0], a2 = arguments[1], n2 = new le(o2), s2 = 1; s2 < a2.length; s2++) {
            ...
            if (n2.countSegment(i3, r2), n2.isOnSegment()) return n2.getLocation();
          }
          return n2.getLocation();
        }
        ...
        if (R(arguments[0], D)) {
          ...
          var n2 = h2.x;
          c2.x -= n2;
          for (var e2 = 0, i3 = 1; u2 - 1 > i3; i3++) l2.y = h2.y, h2.x = c2.x, h2.y = c2.y, a2.getCoordinate(i3 + 1, c2), c2.x -= n2, e2 += h2.x * (l2.y - c2.y);
          return e2 / 2;
        }
      }, he.distanceLineLine = function(t2, e2, n2, i3) {
        if (t2.equals(e2)) return he.distancePointLine(t2, n2, i3);
        if (n2.equals(i3)) return he.distancePointLine(i3, t2, e2);
        var r2 = false;
        ...
        var e2 = t2.length - 1;
        if (3 > e2) throw new i2("Ring has fewer than 4 points, so orientation cannot be determined");
        ...
        if (l2.equals2D(n2) || h2.equals2D(n2) || l2.equals2D(h2)) return false;
        ...
        if (2 === arguments.length) {
          var t2 = arguments[0], e2 = arguments[1];
          if (0 === e2.length) throw new i2("Line array must contain at least one vertex");
        ...
        if (3 === arguments.length) {
          ...
          if (a2.x === u2.x && a2.y === u2.y) return o2.distance(a2);
          var l2 = (u2.x - a2.x) * (u2.x - a2.x) + (u2.y - a2.y) * (u2.y - a2.y), h2 = ((o2.x - a2.x) * (u2.x - a2.x) + (o2.y - a2.y) * (u2.y - a2.y)) / l2;
          if (0 >= h2) return o2.distance(a2);
          if (h2 >= 1) return o2.distance(u2);
        ...
        for (var n2 = new ae(), i3 = 1; i3 < e2.length; i3++) {
          ...
          if (n2.computeIntersection(t2, r2, s2), n2.hasIntersection()) return true;
        }
        return false;
        ...
        if (arguments[0] instanceof ce) {
          ...
          if (r2 >= 1 && s2 >= 1) return null;
          if (0 >= r2 && 0 >= s2) return null;
        ...
        if (e2 > 0 && 1 > e2) return this.project(t2);
        ...
        if (0 !== e2) {
          if (0 >= o2) throw new IllegalStateException("Cannot compute offset from zero-length line segment");
        ...
        if (1 === arguments.length) for (var t2 = arguments[0], e2 = 0; e2 < t2.length; e2++) {
        ...
        for (var t2 = new P("123456789"), e2 = 0; 3 > e2; e2++) for (var n2 = 0; 3 > n2; n2++) t2.setCharAt(3 * e2 + n2, lt.toDimensionSymbol(this.matrix[e2][n2]));
        return t2.toString();
      }, setAll: function(t2) {
        for (var e2 = 0; 3 > e2; e2++) for (var n2 = 0; 3 > n2; n2++) this.matrix[e2][n2] = t2;
      }, get: function(t2, e2) {
        ...
        if (9 !== t2.length) throw new i2("Should be length 9: " + t2);
        for (var e2 = 0; 3 > e2; e2++) for (var n2 = 0; 3 > n2; n2++) if (!fe.matches(this.matrix[e2][n2], t2.charAt(3 * e2 + n2))) return false;
        return true;
      }, add: function(t2) {
        for (var e2 = 0; 3 > e2; e2++) for (var n2 = 0; 3 > n2; n2++) this.setAtLeast(e2, n2, t2.get(e2, n2));
      }, isDisjoint: function() {
      ...
      e(ge.prototype, { addPoint: function(t2) {
        ...
        for (var e2 = he.isCCW(t2), n2 = 0; n2 < t2.length - 1; n2++) this.addTriangle(this.areaBasePt, t2[n2], t2[n2 + 1], e2);
        this.addLineSegments(t2);
      }, getCentroid: function() {
        var t2 = new g();
        if (Math.abs(this.areasum2) > 0) t2.x = this.cg3.x / 3 / this.areasum2, t2.y = this.cg3.y / 3 / this.areasum2;
        else if (this.totalLength > 0) t2.x = this.lineCentSum.x / this.totalLength, t2.y = this.lineCentSum.y / this.totalLength;
        else {
        ...
        if (arguments[0] instanceof Tt) {
          ...
          for (var e2 = 0; e2 < t2.getNumInteriorRing(); e2++) this.addHole(t2.getInteriorRingN(e2).getCoordinates());
        } else if (arguments[0] instanceof B) {
          var n2 = arguments[0];
          if (n2.isEmpty()) return null;
          if (n2 instanceof Lt) this.addPoint(n2.getCoordinate());
          else if (n2 instanceof St) this.addLineSegments(n2.getCoordinates());
          else if (n2 instanceof Tt) {
            var i3 = n2;
            this.add(i3);
          } else if (n2 instanceof ft) for (var r2 = n2, e2 = 0; e2 < r2.getNumGeometries(); e2++) this.add(r2.getGeometryN(e2));
        }
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        ...
        if (0 > t2 || t2 >= this.size()) throw new IndexOutOfBoundsException();
        return this.array_[t2];
        ...
        for (var e2 = new ve(), n2 = 0; n2 < t2.length; n2++) e2.filter(t2[n2]);
        return e2.getCoordinates();
      }, e(me.prototype, { preSort: function(t2) {
        for (var e2 = null, n2 = 1; n2 < t2.length; n2++) (t2[n2].y < t2[0].y || t2[n2].y === t2[0].y && t2[n2].x < t2[0].x) && (e2 = t2[0], t2[0] = t2[n2], t2[n2] = e2);
        ...
        if (t2 = this.cleanRing(t2), 3 === t2.length) return this.geomFactory.createLineString([t2[0], t2[1]]);
        ...
        if (0 !== he.computeOrientation(t2, e2, n2)) return false;
        if (t2.x !== n2.x) {
        ...
        for (var n2 = new at(), i3 = 0; i3 < e2.length; i3++) n2.add(e2[i3]);
        for (var i3 = 0; i3 < t2.length; i3++) he.isPointInRing(t2[i3], e2) || n2.add(t2[i3]);
        ...
        for (var e2 = new Array(3).fill(null), n2 = 0; n2 < e2.length; n2++) n2 < t2.length ? e2[n2] = t2[n2] : e2[n2] = t2[0];
        return e2;
      }, computeOctPts: function(t2) {
        for (var e2 = new Array(8).fill(null), n2 = 0; n2 < e2.length; n2++) e2[n2] = t2[0];
        for (var i3 = 1; i3 < t2.length; i3++) t2[i3].x < e2[0].x && (e2[0] = t2[i3]), t2[i3].x - t2[i3].y < e2[1].x - e2[1].y && (e2[1] = t2[i3]), t2[i3].y > e2[2].y && (e2[2] = t2[i3]), t2[i3].x + t2[i3].y > e2[3].x + e2[3].y && (e2[3] = t2[i3]), t2[i3].x > e2[4].x && (e2[4] = t2[i3]), t2[i3].x - t2[i3].y > e2[5].x - e2[5].y && (e2[5] = t2[i3]), t2[i3].y < e2[6].y && (e2[6] = t2[i3]), t2[i3].x + t2[i3].y < e2[7].x + e2[7].y && (e2[7] = t2[i3]);
        return e2;
        ...
        for (var i3 = 3; i3 < t2.length; i3++) {
          for (e2 = n2.pop(); !n2.empty() && he.computeOrientation(n2.peek(), e2, t2[i3]) > 0; ) e2 = n2.pop();
        ...
        if (a2 === he.COUNTERCLOCKWISE) return 1;
        if (a2 === he.CLOCKWISE) return -1;
        ...
        if (n2) return this.factory.createPolygon(i3, r2.toArray([]));
        var a2 = new I();
        ...
        if (this.inputGeom = t2, this.factory = t2.getFactory(), t2 instanceof Lt) return this.transformPoint(t2, null);
        if (t2 instanceof Pt) return this.transformMultiPoint(t2, null);
        if (t2 instanceof bt) return this.transformLinearRing(t2, null);
        if (t2 instanceof St) return this.transformLineString(t2, null);
        if (t2 instanceof gt) return this.transformMultiLineString(t2, null);
        if (t2 instanceof Tt) return this.transformPolygon(t2, null);
        if (t2 instanceof Ot) return this.transformMultiPolygon(t2, null);
        if (t2 instanceof ft) return this.transformGeometryCollection(t2, null);
        ...
        if (null === n2) return this.factory.createLinearRing(null);
        var i3 = n2.size();
        ...
        for (var n2 = 0; n2 < e2.length; n2++) {
          ...
          if (t2.distance(e2[n2]) < this.snapTolerance) return e2[n2];
        }
        return null;
      }, snapTo: function(t2) {
        ...
        for (var e2 = new at(), n2 = t2.getCoordinates(), i3 = 0; i3 < n2.length; i3++) e2.add(n2[i3]);
        ...
        if (this.isFirst) return this.commonBits = e2, this.commonSignExp = Ce.signExpBits(this.commonBits), this.isFirst = false, null;
        ...
        for (var n2 = 0, i3 = 52; i3 >= 0; i3--) {
          if (Ce.getBit(t2, i3) !== Ce.getBit(e2, i3)) return n2;
          n2++;
        }
        return 52;
        ...
        if (0 === this.commonCoord.x && 0 === this.commonCoord.y) return t2;
        ...
        if (this.atStart) return this.atStart = false, Re.isAtomic(this.parent) && this.index++, this.parent;
        ...
        if (this.atStart) return true;
        if (null !== this.subcollectionIterator) {
          if (this.subcollectionIterator.hasNext()) return true;
          this.subcollectionIterator = null;
        }
        ...
        if (e2 instanceof Lt && this.updateLocationInfo(this.locateInternal(t2, e2)), e2 instanceof St) this.updateLocationInfo(this.locateInternal(t2, e2));
        else if (e2 instanceof Tt) this.updateLocationInfo(this.locateInternal(t2, e2));
        else if (e2 instanceof gt) for (var n2 = e2, i3 = 0; i3 < n2.getNumGeometries(); i3++) {
          var r2 = n2.getGeometryN(i3);
          this.updateLocationInfo(this.locateInternal(t2, r2));
        }
        else if (e2 instanceof Ot) for (var s2 = e2, i3 = 0; i3 < s2.getNumGeometries(); i3++) {
          var o2 = s2.getGeometryN(i3);
          this.updateLocationInfo(this.locateInternal(t2, o2));
        }
        else if (e2 instanceof ft) for (var a2 = new Re(e2); a2.hasNext(); ) {
          var u2 = a2.next();
        ...
        if ("number" == typeof arguments[0] && "number" == typeof arguments[1]) {
          var t2 = arguments[0], e2 = arguments[1];
          if (0 === t2 && 0 === e2) throw new i2("Cannot compute the octant for point ( " + t2 + ", " + e2 + " )");
        ...
        if (arguments[0] instanceof g && arguments[1] instanceof g) {
          ...
          if (0 === a2 && 0 === u2) throw new i2("Cannot compute the octant for two identical points " + s2);
        ...
        for (var e2 = null, n2 = this.items.get(t2); 2 * t2 <= this._size && (e2 = 2 * t2, e2 !== this._size && this.items.get(e2 + 1).compareTo(this.items.get(e2)) < 0 && e2++, this.items.get(e2).compareTo(n2) < 0); t2 = e2) this.items.set(t2, this.items.get(e2));
        ...
        var e2 = this._size;
        for (this.items.set(0, t2); t2.compareTo(this.items.get(Math.trunc(e2 / 2))) < 0; e2 /= 2) this.items.set(e2, this.items.get(Math.trunc(e2 / 2)));
      ...
      var ho = { reverseOrder: function() {
        ...
        for (var i3 = t2.iterator(), r2 = 0, s2 = n2.length; s2 > r2; r2++) i3.next(), i3.set(n2[r2]);
      ...
      e(qe.prototype, { expandToQueue: function(t2, e2) {
        ...
        if (n2 && r2) return qe.area(this.boundable1) > qe.area(this.boundable2) ? (this.expand(this.boundable1, this.boundable2, t2, e2), null) : (this.expand(this.boundable2, this.boundable1, t2, e2), null);
        if (n2) return this.expand(this.boundable1, this.boundable2, t2, e2), null;
        if (r2) return this.expand(this.boundable2, this.boundable1, t2, e2), null;
        ...
        if (1 === arguments.length) {
          for (var e2 = arguments[0], n2 = new I(), i3 = e2.getChildBoundables().iterator(); i3.hasNext(); ) {
            ...
            if (r2 instanceof Ge) {
              ...
              null !== s2 && n2.add(s2);
            } else r2 instanceof Me ? n2.add(r2.getItem()) : f.shouldNeverReachHere();
          }
        ...
        if (3 === arguments.length) {
          var n2 = arguments[0], i3 = arguments[1], r2 = arguments[2];
          if (f.isTrue(n2 > -2), i3.getLevel() === n2) return r2.add(i3), null;
        ...
        if (2 === arguments.length) {
          ...
          if (R(arguments[2], Ae) && arguments[0] instanceof Object && arguments[1] instanceof Ge) for (var r2 = arguments[0], s2 = arguments[1], o2 = arguments[2], a2 = s2.getChildBoundables(), u2 = 0; u2 < a2.size(); u2++) {
            var l2 = a2.get(u2);
          ...
          else if (R(arguments[2], y) && arguments[0] instanceof Object && arguments[1] instanceof Ge) for (var h2 = arguments[0], c2 = arguments[1], g2 = arguments[2], a2 = c2.getChildBoundables(), u2 = 0; u2 < a2.size(); u2++) {
            var l2 = a2.get(u2);
        ...
        for (var n2 = new I(), i3 = 0; i3 < t2.length; i3++) n2.addAll(this.createParentBoundablesFromVerticalSlice(t2[i3], e2));
        return n2;
        ...
        for (var o2 = t2.segmentIndex + 1; o2 <= e2.segmentIndex; o2++) n2.add(this.edge.getCoordinate(o2));
        ...
        for (var a2 = t2.segmentIndex + 1; a2 <= e2.segmentIndex; a2++) s2[o2++] = this.edge.getCoordinate(a2);
        ...
        if (!i3.equals2D(e2[0])) throw new l("bad split edge start point at " + i3);
        var r2 = t2.get(t2.size() - 1), s2 = r2.getCoordinates(), o2 = s2[s2.length - 1];
        if (!o2.equals2D(e2[e2.length - 1])) throw new l("bad split edge end point at " + o2);
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        return He;
        ...
        for (var i3 = 0; i3 < t2.getIntersectionNum(); i3++) this.addIntersection(t2, e2, n2, i3);
      }, interfaces_: function() {
        return [je];
      }, getClass: function() {
        return Ke;
        ...
        if (2 === arguments.length) for (var n2 = arguments[0], i3 = arguments[1], r2 = n2.iterator(); r2.hasNext(); ) {
          var s2 = r2.next();
        ...
        if (i3.tempEnv1.init(r2, s2), n2 - e2 === 1) return i3.select(this, e2), null;
        if (!t2.intersects(i3.tempEnv1)) return null;
        var o2 = Math.trunc((e2 + n2) / 2);
        o2 > e2 && this.computeSelect(t2, e2, o2, i3), n2 > o2 && this.computeSelect(t2, o2, n2, i3);
      }, getCoordinates: function() {
        for (var t2 = new Array(this.end - this.start + 1).fill(null), e2 = 0, n2 = this.start; n2 <= this.end; n2++) t2[e2++] = this.pts[n2];
        return t2;
        ...
        if (e2 - t2 === 1 && r2 - i3 === 1) return s2.overlap(this, t2, n2, i3), null;
        if (s2.tempEnv1.init(o2, a2), s2.tempEnv2.init(u2, l2), !s2.tempEnv1.intersects(s2.tempEnv2)) return null;
        ...
        if ("number" == typeof arguments[0] && "number" == typeof arguments[1]) {
          var t2 = arguments[0], e2 = arguments[1];
          if (0 === t2 && 0 === e2) throw new i2("Cannot compute the quadrant for point ( " + t2 + ", " + e2 + " )");
          return t2 >= 0 ? e2 >= 0 ? Je.NE : Je.SE : e2 >= 0 ? Je.NW : Je.SW;
        }
        if (arguments[0] instanceof g && arguments[1] instanceof g) {
          var n2 = arguments[0], r2 = arguments[1];
          if (r2.x === n2.x && r2.y === n2.y) throw new i2("Cannot compute the quadrant for two identical points " + n2);
        ...
        for (var n2 = e2; n2 < t2.length - 1 && t2[n2].equals2D(t2[n2 + 1]); ) n2++;
        ...
        for (var e2 = new Array(t2.size()).fill(null), n2 = 0; n2 < e2.length; n2++) e2[n2] = t2.get(n2).intValue();
        return e2;
        ...
        for (var t2 = new rn(this.segInt), e2 = this.monoChains.iterator(); e2.hasNext(); ) for (var n2 = e2.next(), i3 = this.index.query(n2.getEnvelope()), r2 = i3.iterator(); r2.hasNext(); ) {
          var s2 = r2.next();
          if (s2.getId() > n2.getId() && (n2.computeOverlaps(s2, t2), this.nOverlaps++), this.segInt.isDone()) return null;
        }
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        ...
        for (var e2 = 0; e2 < this.location.length; e2++) this.location[e2] = t2;
      }, isNull: function() {
        for (var t2 = 0; t2 < this.location.length; t2++) if (this.location[t2] !== L.NONE) return false;
        return true;
      }, setAllLocationsIfNull: function(t2) {
        for (var e2 = 0; e2 < this.location.length; e2++) this.location[e2] === L.NONE && (this.location[e2] = t2);
      }, isLine: function() {
        ...
        for (var n2 = 0; n2 < this.location.length; n2++) this.location[n2] === L.NONE && n2 < t2.location.length && (this.location[n2] = t2.location[n2]);
        ...
        for (var t2 = 0; t2 < this.location.length; t2++) if (this.location[t2] === L.NONE) return true;
        return false;
        ...
        for (var e2 = 0; e2 < this.location.length; e2++) if (this.location[e2] !== t2) return false;
        return true;
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        ...
        for (var e2 = 0; 2 > e2; e2++) null === this.elt[e2] && null !== t2.elt[e2] ? this.elt[e2] = new fn(t2.elt[e2]) : this.elt[e2].merge(t2.elt[e2]);
      }, flip: function() {
        ...
        for (var e2 = new gn(L.NONE), n2 = 0; 2 > n2; n2++) e2.setLocation(n2, t2.getLocation(n2));
        return e2;
      }, e(dn.prototype, { computeRing: function() {
        if (null !== this.ring) return null;
        for (var t2 = new Array(this.pts.size()).fill(null), e2 = 0; e2 < this.pts.size(); e2++) t2[e2] = this.pts.get(e2);
        ...
        var e2 = t2, n2 = true;
        do {
          if (null === e2) throw new sn("Found null DirectedEdge");
          if (e2.getEdgeRing() === this) throw new sn("Directed Edge visited twice during ring-building at " + e2.getCoordinate());
          this.edges.add(e2);
          var i3 = e2.getLabel();
        ...
        if (e2) {
          var r2 = 1;
          n2 && (r2 = 0);
          for (var s2 = r2; s2 < i3.length; s2++) this.pts.add(i3[s2]);
        } else {
          var r2 = i3.length - 2;
          n2 && (r2 = i3.length - 1);
          for (var s2 = r2; s2 >= 0; s2--) this.pts.add(i3[s2]);
        }
      }, isHole: function() {
        return this._isHole;
        ...
        if (!n2.contains(t2)) return false;
        if (!he.isPointInRing(t2, e2.getCoordinates())) return false;
        for (var i3 = this.holes.iterator(); i3.hasNext(); ) {
          var r2 = i3.next();
          if (r2.containsPoint(t2)) return false;
        }
        return true;
      }, addHole: function(t2) {
        this.holes.add(t2);
        ...
        if (1 === arguments.length) {
          ...
          if (i3 === L.NONE) return null;
          if (this.label.getLocation(n2) === L.NONE) return this.label.setLocation(n2, i3), null;
        }
      }, setShell: function(t2) {
        this.shell = t2, null !== t2 && t2.addHole(this);
      }, toPolygon: function(t2) {
        for (var e2 = new Array(this.holes.size()).fill(null), n2 = 0; n2 < this.holes.size(); n2++) e2[n2] = this.holes.get(n2).getLinearRing();
        ...
        for (var t2 = this.getEdges().getEdges().iterator(); t2.hasNext(); ) {
          var e2 = t2.next();
          if (e2.getEdge().isInResult()) return true;
        }
        return false;
      }, isIsolated: function() {
        return 1 === this.label.getGeometryCount();
        ...
        } else if (arguments[0] instanceof gn) for (var e2 = arguments[0], n2 = 0; 2 > n2; n2++) {
        ...
        if (-999 !== this.depth[t2] && this.depth[t2] !== e2) throw new sn("assigned depths do not match", this.getCoordinate());
        this.depth[t2] = e2;
      }, isInteriorAreaEdge: function t2() {
        for (var t3 = true, e2 = 0; 2 > e2; e2++) this.label.isArea(e2) && this.label.getLocation(e2, cn.LEFT) === L.INTERIOR && this.label.getLocation(e2, cn.RIGHT) === L.INTERIOR || (t3 = false);
        return t3;
        ...
        for (var n2 = 0; n2 < this.edges.size(); n2++) {
          ...
          if (this.matchInSameDirection(t2, e2, r2[0], r2[1])) return i3;
          if (this.matchInSameDirection(t2, e2, r2[r2.length - 1], r2[r2.length - 2])) return i3;
        }
        return null;
        ...
        for (var n2 = 0; n2 < this.edges.size(); n2++) {
          var i3 = this.edges.get(n2), r2 = i3.getCoordinates();
          if (t2.equals(r2[0]) && e2.equals(r2[1])) return i3;
        }
        return null;
      }, interfaces_: function() {
        return [];
        ...
        for (var n2 = e2.iterator(); n2.hasNext(); ) {
          ...
          if (null === i3.getShell()) {
            ...
            if (null === r2) throw new sn("unable to assign hole to a shell", i3.getCoordinate(0));
            i3.setShell(r2);
          }
        }
        ...
        for (var e2 = this.shellList.iterator(); e2.hasNext(); ) {
          var n2 = e2.next();
          if (n2.containsPoint(t2)) return true;
        }
        return false;
        ...
        if (!Tn.isPointInRing(t2, n2)) return false;
        for (var i3 = 0; i3 < e2.getNumInteriorRing(); i3++) {
          var r2 = e2.getInteriorRingN(i3);
          if (Tn.isPointInRing(t2, r2)) return false;
        }
        return true;
      }, Tn.containsPoint = function(t2, e2) {
        if (e2 instanceof Tt) return Tn.containsPointInPolygon(t2, e2);
        if (e2 instanceof ft) for (var n2 = new Re(e2); n2.hasNext(); ) {
          var i3 = n2.next();
          if (i3 !== e2 && Tn.containsPoint(t2, i3)) return true;
        }
        return false;
        ...
        for (var s2 = e2, n2 = this.iterator(); n2.hasNext(); ) {
          ...
          if (r2.getLocation(t2, cn.ON) === L.NONE && r2.setLocation(t2, cn.ON, s2), r2.isArea(t2)) {
            ...
            if (a2 !== L.NONE) {
              if (a2 !== s2) throw new sn("side location conflict", i3.getCoordinate());
              o2 === L.NONE && f.shouldNeverReachHere("found single null side (at " + i3.getCoordinate() + ")"), s2 = o2;
            } else f.isTrue(r2.getLocation(t2, cn.LEFT) === L.NONE, "found single null side"), r2.setLocation(t2, cn.RIGHT, s2), r2.setLocation(t2, cn.LEFT, s2);
          }
        }
      }, getCoordinate: function() {
        var t2 = this.iterator();
        if (!t2.hasNext()) return null;
        var e2 = t2.next();
        ...
        for (var e2 = [false, false], n2 = this.iterator(); n2.hasNext(); ) for (var i3 = n2.next(), r2 = i3.getLabel(), s2 = 0; 2 > s2; s2++) r2.isLine(s2) && r2.getLocation(s2) === L.BOUNDARY && (e2[s2] = true);
        for (var n2 = this.iterator(); n2.hasNext(); ) for (var i3 = n2.next(), r2 = i3.getLabel(), s2 = 0; 2 > s2; s2++) if (r2.isAnyNull(s2)) {
          var o2 = L.NONE;
          if (e2[s2]) o2 = L.EXTERIOR;
          else {
        ...
        if (n2 === this.LINKING_TO_OUTGOING) {
          if (null === t2) throw new sn("no outgoing dirEdge found", this.getCoordinate());
        ...
        if (Je.isNorthern(r2) && Je.isNorthern(s2)) return n2;
        if (!Je.isNorthern(r2) && !Je.isNorthern(s2)) return i3;
        ...
        if (1 === arguments.length) {
          ...
          if (s2 !== i3) throw new sn("depth mismatch at " + t2.getCoordinate());
        } else if (3 === arguments.length) {
        ...
        for (var e2 = this.iterator(); e2.hasNext(); ) for (var n2 = e2.next(), i3 = n2.getEdge(), r2 = i3.getLabel(), s2 = 0; 2 > s2; s2++) {
        ...
        if (t2 === n2 && 1 === this.li.getIntersectionNum()) {
          if (An.isAdjacentSegments(e2, i3)) return true;
          if (t2.isClosed()) {
            var r2 = t2.getNumPoints() - 1;
            if (0 === e2 && i3 === r2 || 0 === i3 && e2 === r2) return true;
          }
        }
        return false;
        ...
        for (var n2 = e2.iterator(); n2.hasNext(); ) {
          ...
          if (t2.isIntersection(r2)) return true;
        }
        return false;
        ...
        if (1 === arguments.length) for (var t2 = arguments[0], e2 = t2.iterator(); e2.hasNext(); ) {
          var n2 = e2.next();
          this.addEdge(n2, n2);
        }
        else if (2 === arguments.length) for (var i3 = arguments[0], r2 = arguments[1], e2 = i3.iterator(); e2.hasNext(); ) {
          var n2 = e2.next();
          this.addEdge(n2, r2);
        }
      }, interfaces_: function() {
        ...
        var s2 = new Array(n2).fill(null), o2 = 0;
        s2[o2++] = new g(t2.coord);
        for (var a2 = t2.segmentIndex + 1; a2 <= e2.segmentIndex; a2++) s2[o2++] = this.edge.pts[a2];
        ...
        for (var e2 = this.iterator(); e2.hasNext(); ) {
          var n2 = e2.next();
          if (n2.coord.equals(t2)) return true;
        }
        return false;
      }, interfaces_: function() {
        return [];
        ...
        if (4 === arguments.length) {
          ...
          if (s2 - r2 === 1 && u2 - a2 === 1) return l2.addIntersections(this.e, r2, o2.e, a2), null;
          if (this.env1.init(h2, c2), this.env2.init(f2, g2), !this.env1.intersects(this.env2)) return null;
        ...
        for (var n2 = 0; n2 < this.startIndex.length - 1; n2++) for (var i3 = 0; i3 < t2.startIndex.length - 1; i3++) this.computeIntersectsForChain(n2, t2, i3, e2);
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        return Zn;
        ...
        if (0 === arguments.length) {
          for (var t2 = 0; 2 > t2; t2++) for (var e2 = 0; 3 > e2; e2++) if (this.depth[t2][e2] !== Qn.NULL_VALUE) return false;
          return true;
        }
        if (1 === arguments.length) {
          var n2 = arguments[0];
        ...
        for (var t2 = 0; 2 > t2; t2++) if (!this.isNull(t2)) {
        ...
        if (1 === arguments.length) for (var t2 = arguments[0], e2 = 0; 2 > e2; e2++) for (var n2 = 1; 3 > n2; n2++) {
        ...
        if (!(t2 instanceof Jn)) return false;
        var e2 = t2;
        if (this.pts.length !== e2.pts.length) return false;
        for (var n2 = true, i3 = true, r2 = this.pts.length, s2 = 0; s2 < this.pts.length; s2++) if (this.pts[s2].equals2D(e2.pts[s2]) || (n2 = false), this.pts[s2].equals2D(e2.pts[--r2]) || (i3 = false), !n2 && !i3) return false;
        return true;
      }, getCoordinate: function() {
        ...
        for (var e2 = 0; e2 < this.pts.length; e2++) e2 > 0 && t2.print(","), t2.print(this.pts[e2].x + " " + this.pts[e2].y);
        ...
        for (var e2 = this.pts.length - 1; e2 >= 0; e2--) t2.print(this.pts[e2] + " ");
        t2.println("");
        ...
        if (null === this.env) {
          this.env = new C();
          for (var t2 = 0; t2 < this.pts.length; t2++) this.env.expandToInclude(this.pts[t2]);
        }
        return this.env;
        ...
        for (var e2 = 0; e2 < this.pts.length; e2++) e2 > 0 && t2.append(","), t2.append(this.pts[e2].x + " " + this.pts[e2].y);
        ...
        for (var e2 = 0; e2 < this.pts.length; e2++) if (!this.pts[e2].equals2D(t2.pts[e2])) return false;
        return true;
        ...
        if (e2.length < 2) return this._hasTooFewPoints = true, this.invalidPoint = e2[0], null;
        ...
        if (i3.length < 4) return this._hasTooFewPoints = true, this.invalidPoint = i3[0], null;
        var r2 = e2, s2 = n2;
        ...
        for (var e2 = this.edges.iterator(); e2.hasNext(); ) for (var n2 = e2.next(), i3 = n2.getLabel().getLocation(t2), r2 = n2.eiList.iterator(); r2.hasNext(); ) {
          var s2 = r2.next();
        ...
        var t2 = arguments[0];
        if (t2.isEmpty()) return null;
        if (t2 instanceof Ot && (this.useBoundaryDeterminationRule = false), t2 instanceof Tt) this.addPolygon(t2);
        else if (t2 instanceof St) this.addLineString(t2);
        else if (t2 instanceof Lt) this.addPoint(t2);
        else if (t2 instanceof Pt) this.addCollection(t2);
        else if (t2 instanceof gt) this.addCollection(t2);
        else if (t2 instanceof Ot) this.addCollection(t2);
        else {
          if (!(t2 instanceof ft)) throw new UnsupportedOperationException(t2.getClass().getName());
        ...
        for (var e2 = 0; e2 < this.edges.size(); e2++) {
          ...
          for (var i3 = n2.getCoordinates(), r2 = 0; r2 < i3.length; r2++) r2 > 0 && t2.print(","), t2.print(i3[r2].x + " " + i3[r2].y);
          t2.println(")");
        }
        t2.print(")  ");
      }, addAll: function(t2) {
        ...
        for (var e2 = 0; e2 < this.edges.size(); e2++) if (this.edges.get(e2).equals(t2)) return e2;
        return -1;
      }, iterator: function() {
        return this.edges.iterator();
      }, getEdges: function() {
        ...
        for (var t2 = this.edgeList.iterator(); t2.hasNext(); ) {
          ...
          if (!i3.isNull()) {
            i3.normalize();
            for (var r2 = 0; 2 > r2; r2++) n2.isNull(r2) || !n2.isArea() || i3.isNull(r2) || (0 === i3.getDelta(r2) ? n2.toLine(r2) : (f.isTrue(!i3.isNull(r2, cn.LEFT), "depth of LEFT side has not been initialized"), n2.setLocation(r2, cn.LEFT, i3.getLocation(r2, cn.LEFT)), f.isTrue(!i3.isNull(r2, cn.RIGHT), "depth of RIGHT side has not been initialized"), n2.setLocation(r2, cn.RIGHT, i3.getLocation(r2, cn.RIGHT))));
          }
        }
        ...
        if (t2.isEmpty() || e2.isEmpty()) return ii.createEmptyResult(ii.INTERSECTION, t2, e2, t2.getFactory());
        ...
        if (t2.isEmpty() || e2.isEmpty()) {
          if (t2.isEmpty() && e2.isEmpty()) return ii.createEmptyResult(ii.SYMDIFFERENCE, t2, e2, t2.getFactory());
        ...
        if (0 === i3.getLength()) n2 = 0, e2 = i3.getCoordinate();
        else {
        ...
        if (arguments[0] instanceof ft) {
          ...
          for (var t3 = e2.getGeometryN(0), n2 = 1; n2 < e2.getNumGeometries(); n2++) e2.getGeometryN(n2).getEnvelopeInternal().getWidth() > t3.getEnvelopeInternal().getWidth() && (t3 = e2.getGeometryN(n2));
          return t3;
        }
        if (arguments[0] instanceof B) {
          var i3 = arguments[0];
        ...
        if (t2 instanceof Tt) this.addPolygon(t2);
        else if (t2 instanceof ft) for (var e2 = t2, n2 = 0; n2 < e2.getNumGeometries(); n2++) this.add(e2.getGeometryN(n2));
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        return oi;
        ...
        for (var t2 = 0; t2 < this.poly.getNumInteriorRing(); t2++) this.process(this.poly.getInteriorRingN(t2));
        ...
        if (arguments[0] instanceof B) {
          var t2 = arguments[0];
          if (t2 instanceof St) this.addEndpoints(t2.getCoordinates());
          else if (t2 instanceof ft) for (var e2 = t2, n2 = 0; n2 < e2.getNumGeometries(); n2++) this.addEndpoints(e2.getGeometryN(n2));
        ...
        if (arguments[0] instanceof B) {
          var t2 = arguments[0];
          if (t2 instanceof St) this.addInterior(t2.getCoordinates());
          else if (t2 instanceof ft) for (var e2 = t2, n2 = 0; n2 < e2.getNumGeometries(); n2++) this.addInterior(e2.getGeometryN(n2));
        } else if (arguments[0] instanceof Array) for (var i3 = arguments[0], n2 = 1; n2 < i3.length - 1; n2++) this.add(i3[n2]);
      }, add: function(t2) {
        ...
        if (arguments[0] instanceof B) {
          var t2 = arguments[0];
          if (t2 instanceof Lt) this.add(t2.getCoordinate());
          else if (t2 instanceof ft) for (var e2 = t2, n2 = 0; n2 < e2.getNumGeometries(); n2++) this.add(e2.getGeometryN(n2));
        } else if (arguments[0] instanceof g) {
        ...
        for (; t2 > Math.PI; ) t2 -= hi.PI_TIMES_2;
        for (; t2 <= -Math.PI; ) t2 += hi.PI_TIMES_2;
        return t2;
      }, hi.angle = function() {
        if (1 === arguments.length) {
        ...
        if (0 > t2) {
          for (; 0 > t2; ) t2 += hi.PI_TIMES_2;
          t2 >= hi.PI_TIMES_2 && (t2 = 0);
        } else {
          for (; t2 >= hi.PI_TIMES_2; ) t2 -= hi.PI_TIMES_2;
          0 > t2 && (t2 = 0);
        }
        return t2;
        ...
        if (null === t2) throw new i2("Supplied point is null.");
        ...
        if (n2[0].equals2D(n2[n2.length - 1]) && (t2 = new Array(n2.length - 1).fill(null), H.copyDeep(n2, 0, t2, 0, n2.length - 1)), t2.length <= 2) return this.extremalPts = H.copyDeep(t2), null;
        for (var i3 = fi.lowestPoint(t2), r2 = fi.pointWitMinAngleWithX(t2, i3), s2 = 0; s2 < t2.length; s2++) {
          ...
          if (hi.isObtuse(i3, o2, r2)) return this.extremalPts = [new g(i3), new g(r2)], null;
          if (hi.isObtuse(o2, i3, r2)) i3 = o2;
          else {
            if (!hi.isObtuse(o2, r2, i3)) return this.extremalPts = [new g(i3), new g(r2), new g(o2)], null;
            r2 = o2;
          }
        }
        ...
        for (var e2 = t2[0], n2 = 1; n2 < t2.length; n2++) t2[n2].y < e2.y && (e2 = t2[n2]);
        return e2;
        ...
        for (var e2 = 1, n2 = new ce(), i3 = 0; i3 < t2.length - 1; i3++) n2.p0 = t2[i3], n2.p1 = t2[i3 + 1], e2 = this.findMaxPerpDistance(t2, n2, e2);
        ...
        for (var i3 = e2.distancePerpendicular(t2[n2]), r2 = i3, s2 = n2, o2 = s2; r2 >= i3; ) i3 = r2, s2 = o2, o2 = gi.nextIndex(t2, s2), r2 = e2.distancePerpendicular(t2[o2]);
      ...
      e(di.prototype, { getResultGeometry: function() {
        ...
        if (0 >= t2) throw new i2("Tolerance must be positive");
        this.distanceTolerance = t2;
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        ...
        for (var i3 = new ce(), r2 = new N(), s2 = 0; s2 < t2.length - 1; s2++) {
          ...
          if (a2 > 1) for (var u2 = o2 / a2, l2 = 1; a2 > l2; l2++) {
      ...
      e(vi.prototype, { find: function(t2) {
        ...
        do {
          ...
          if (r2 !== e2 || i3 === this) return n2.insertAfter(t2), null;
          n2 = i3;
        } while (n2 !== this);
        f.shouldNeverReachHere();
        ...
        if (!yi.isValidEdge(t2, e2)) return null;
        var n2 = this.vertexMap.get(t2), i3 = null;
        if (null !== n2 && (i3 = n2.find(e2)), null !== i3) return i3;
        ...
        for (this.ringStartEdge = null, mi.markBoth(n2), e2.add(n2.orig().copy(), false); 2 === n2.sym().degree(); ) {
          ...
          var i3 = n2.next();
          if (i3 === t2) return this.buildRing(this.ringStartEdge), null;
        ...
        } else if (R(arguments[0], v)) for (var e2 = arguments[0], n2 = e2.iterator(); n2.hasNext(); ) {
          var i3 = n2.next();
          this.add(i3);
        }
      ...
      e(Ni.prototype, { hasChildren: function() {
        for (var t2 = 0; 4 > t2; t2++) if (null !== this.subnode[t2]) return true;
        return false;
      }, isPrunable: function() {
        return !(this.hasChildren() || this.hasItems());
      }, addAllItems: function(t2) {
        t2.addAll(this.items);
        for (var e2 = 0; 4 > e2; e2++) null !== this.subnode[e2] && this.subnode[e2].addAllItems(t2);
        return t2;
      }, getNodeCount: function() {
        for (var t2 = 0, e2 = 0; 4 > e2; e2++) null !== this.subnode[e2] && (t2 += this.subnode[e2].size());
        return t2 + 1;
      }, size: function() {
        for (var t2 = 0, e2 = 0; 4 > e2; e2++) null !== this.subnode[e2] && (t2 += this.subnode[e2].size());
        ...
        for (var n2 = 0; 4 > n2; n2++) null !== this.subnode[n2] && this.subnode[n2].addAllItemsFromOverlapping(t2, e2);
      }, visitItems: function(t2, e2) {
        for (var n2 = this.items.iterator(); n2.hasNext(); ) e2.visitItem(n2.next());
      }, hasItems: function() {
        return !this.items.isEmpty();
      }, remove: function(t2, e2) {
        if (!this.isSearchMatch(t2)) return false;
        for (var n2 = false, i3 = 0; 4 > i3; i3++) if (null !== this.subnode[i3] && (n2 = this.subnode[i3].remove(t2, e2))) {
        ...
        for (var n2 = 0; 4 > n2; n2++) null !== this.subnode[n2] && this.subnode[n2].visit(t2, e2);
      }, getItems: function() {
        return this.items;
      }, depth: function() {
        for (var t2 = 0, e2 = 0; 4 > e2; e2++) if (null !== this.subnode[e2]) {
        ...
        for (var e2 = 0; 4 > e2; e2++) null !== this.subnode[e2] && (this.subnode[e2].isEmpty() || (t3 = false));
        return t3;
      }, add: function(t2) {
        this.items.add(t2);
      }, interfaces_: function() {
        ...
        if (1 === arguments.length) {
          var t2 = arguments[0];
          for (this.level = wi.computeQuadLevel(t2), this.env = new C(), this.computeKey(this.level, t2); !this.env.contains(t2); ) this.level += 1, this.computeKey(this.level, t2);
        } else if (2 === arguments.length) {
        ...
        if (t2.level === this.level - 1) this.subnode[e2] = t2;
        else {
      ...
      e(bi.prototype, { read: function(t2) {
        ...
        var n2 = e2.type;
        if (!xo[n2]) throw new Error("Unknown GeoJSON type: " + e2.type);
        ...
        if (!Eo[e2]) throw new Error("Geometry is not supported");
      ...
      var xo = { Feature: function(t2) {
        ...
        if (t2.geometry) {
          ...
          if (!xo[i3]) throw new Error("Unknown GeoJSON type: " + t2.type);
        ...
        for (var e2 = [], n2 = 0; n2 < t2.length; ++n2) e2.push(xo.Point.apply(this, [t2[n2]]));
        ...
        for (var e2 = [], n2 = 0; n2 < t2.length; ++n2) e2.push(xo.LineString.apply(this, [t2[n2]]));
      ...
      e(Oi.prototype, { read: function(t2) {
        ...
        var e2, n2;
        if (t2.coordinate) this.precisionModel.makePrecise(t2.coordinate);
        else if (t2.points) for (e2 = 0, n2 = t2.points.length; n2 > e2; e2++) this.precisionModel.makePrecise(t2.points[e2]);
        else if (t2.geometries) for (e2 = 0, n2 = t2.geometries.length; n2 > e2; e2++) this.reducePrecision(t2.geometries[e2]);
        ...
        if (t2.coordinate) this.precisionModel.makePrecise(t2.coordinate);
        else if (t2.points) for (var e2 = 0, n2 = t2.points.coordinates.length; n2 > e2; e2++) this.precisionModel.makePrecise(t2.points.coordinates[e2]);
        else if (t2.geometries) for (var i3 = 0, r2 = t2.geometries.length; r2 > i3; i3++) this.reducePrecision(t2.geometries[i3]);
        ...
        for (var e2 = [t2.shell.points.coordinates.map(Di)], n2 = 0; n2 < t2.holes.length; n2++) e2.push(t2.holes[n2].points.coordinates.map(Di));
        ...
        for (var e2 = [], n2 = 0; n2 < t2.geometries.length; n2++) e2.push(this.convertToLineString(t2.geometries[n2]).getCoordinates());
        return new ol.geom.MultiLineString(e2);
      }, convertToMultiPolygon: function(t2) {
        for (var e2 = [], n2 = 0; n2 < t2.geometries.length; n2++) e2.push(this.convertToPolygon(t2.geometries[n2]).getCoordinates());
      ...
      e(Fi.prototype, { rescale: function() {
        if (R(arguments[0], v)) for (var t2 = arguments[0], e2 = t2.iterator(); e2.hasNext(); ) {
          var n2 = e2.next();
          ...
          for (var e2 = 0; e2 < i3.length; e2++) i3[e2].x = i3[e2].x / this.scaleFactor + this.offsetX, i3[e2].y = i3[e2].y / this.scaleFactor + this.offsetY;
        ...
        if (arguments[0] instanceof Array) {
          for (var r2 = arguments[0], s2 = new Array(r2.length).fill(null), n2 = 0; n2 < r2.length; n2++) s2[n2] = new g(Math.round((r2[n2].x - this.offsetX) * this.scaleFactor), Math.round((r2[n2].y - this.offsetY) * this.scaleFactor), r2[n2].z);
      ...
      e(Gi.prototype, { isSimpleMultiPoint: function(t2) {
        ...
        for (var e2 = new at(), n2 = 0; n2 < t2.getNumGeometries(); n2++) {
          ...
          if (e2.contains(r2)) return this.nonSimpleLocation = r2, false;
          e2.add(r2);
        }
        return true;
        ...
        for (var e2 = kn.getLines(t2), n2 = e2.iterator(); n2.hasNext(); ) {
          var i3 = n2.next();
          if (!this.isSimpleLinearGeometry(i3)) return false;
        }
        return true;
        ...
        for (var n2 = e2.values().iterator(); n2.hasNext(); ) {
          var a2 = n2.next();
          if (a2.isClosed && 2 !== a2.degree) return this.nonSimpleLocation = a2.getCoordinate(), true;
        }
        return false;
        ...
        for (var e2 = t2.getEdgeIterator(); e2.hasNext(); ) for (var n2 = e2.next(), i3 = n2.getMaximumSegmentIndex(), r2 = n2.getEdgeIntersectionList().iterator(); r2.hasNext(); ) {
          var s2 = r2.next();
          if (!s2.isEndPoint(i3)) return this.nonSimpleLocation = s2.getCoordinate(), true;
        }
        return false;
        ...
        if (0 > e2 || e2 + 1 >= i3.length) return -1;
        if (i3[e2].y === i3[e2 + 1].y) return -1;
        var r2 = cn.LEFT;
        return i3[e2].y < i3[e2 + 1].y && (r2 = cn.RIGHT), r2;
      }, getEdge: function() {
        return this.orientedDe;
      }, checkForRightmostCoordinate: function(t2) {
        for (var e2 = t2.getEdge().getCoordinates(), n2 = 0; n2 < e2.length - 1; n2++) (null === this.minCoord || e2[n2].x > this.minCoord.x) && (this.minDe = t2, this.minIndex = n2, this.minCoord = e2[n2]);
        ...
        if (null === e2) throw new sn("unable to find edge to compute depths at " + t2.getCoordinate());
        ...
        if (null === this.env) {
          for (var t2 = new C(), e2 = this.dirEdgeList.iterator(); e2.hasNext(); ) for (var n2 = e2.next(), i3 = n2.getEdge().getCoordinates(), r2 = 0; r2 < i3.length - 1; r2++) t2.expandToInclude(i3[r2]);
          this.env = t2;
        }
        return this.env;
        ...
        0 >= s2 && (s2 = 1);
        for (var o2 = n2; i3 > o2; o2 += s2) if (!this.isShallow(t2, e2, this.inputLine[o2], r2)) return false;
        return true;
        ...
        for (var e2 = t2 + 1; e2 < this.inputLine.length && this.isDeleted[e2] === Yi.DELETE; ) e2++;
        return e2;
      }, isShallow: function(t2, e2, n2, i3) {
        var r2 = he.distancePointLine(e2, t2, n2);
        return i3 > r2;
      }, collapseLine: function() {
        for (var t2 = new N(), e2 = 0; e2 < this.inputLine.length; e2++) this.isDeleted[e2] !== Yi.DELETE && t2.add(this.inputLine[e2]);
        return t2.toCoordinateArray();
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        ...
        if (e2) for (var n2 = 0; n2 < t2.length; n2++) this.addPt(t2[n2]);
        else for (var n2 = t2.length - 1; n2 >= 0; n2--) this.addPt(t2[n2]);
        ...
        if (this.s0 = this.s1, this.s1 = this.s2, this.s2 = t2, this.seg0.setCoordinates(this.s0, this.s1), this.computeOffsetSegment(this.seg0, this.side, this.distance, this.offset0), this.seg1.setCoordinates(this.s1, this.s2), this.computeOffsetSegment(this.seg1, this.side, this.distance, this.offset1), this.s1.equals(this.s2)) return null;
        ...
        else if (this._hasNarrowConcaveAngle = true, this.offset0.p1.distance(this.offset1.p0) < this.distance * Xi.INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR) this.segList.addPt(this.offset0.p1);
        else {
        ...
        if (this.distance = e2, 0 === e2) return null;
        ...
        for (var s2 = 2; r2 >= s2; s2++) e2.addNextSegment(i3[s2], true);
        ...
        for (var s2 = a2 - 2; s2 >= 0; s2--) e2.addNextSegment(o2[s2], true);
        ...
        if (this.distance = e2, 0 > e2 && !this.bufParams.isSingleSided()) return null;
        if (0 === e2) return null;
        var n2 = Math.abs(e2), i3 = this.getSegGen(n2);
        if (t2.length <= 1) this.computePointCurve(t2[0], i3);
        else if (this.bufParams.isSingleSided()) {
          var r2 = 0 > e2;
          this.computeSingleSidedBufferCurve(t2, r2, i3);
        } else this.computeLineBufferCurve(t2, i3);
        ...
        if (this.distance = n2, t2.length <= 2) return this.getLineCurve(t2, n2);
        if (0 === n2) return Hi.copyCoordinates(t2);
        ...
        for (var e2 = new Array(t2.length).fill(null), n2 = 0; n2 < e2.length; n2++) e2[n2] = new g(t2[n2]);
        return e2;
        ...
        if (3 === arguments.length) {
          if (R(arguments[2], y) && arguments[0] instanceof g && arguments[1] instanceof In) for (var s2 = arguments[0], o2 = arguments[1], a2 = arguments[2], u2 = o2.getEdge().getCoordinates(), n2 = 0; n2 < u2.length - 1; n2++) {
          ...
          else if (R(arguments[2], y) && arguments[0] instanceof g && R(arguments[1], y)) for (var f2 = arguments[0], d2 = arguments[1], p2 = arguments[2], n2 = d2.iterator(); n2.hasNext(); ) {
            var v2 = n2.next();
        ...
        var e2 = t2;
        if (this.upwardSeg.minX() >= e2.upwardSeg.maxX()) return 1;
        if (this.upwardSeg.maxX() <= e2.upwardSeg.minX()) return -1;
        ...
        if (this.distance < 0 && this.isErodedCompletely(i3, this.distance)) return null;
        if (this.distance <= 0 && r2.length < 3) return null;
        ...
        if (0 === e2 && t2.length < bt.MINIMUM_VALID_SIZE) return null;
        var s2 = i3, o2 = r2;
        ...
        if (t2 === n2 && 1 === this.li.getIntersectionNum()) {
          if (Zi.isAdjacentSegments(e2, i3)) return true;
          if (t2.isClosed()) {
            var r2 = t2.size() - 1;
            if (0 === e2 && i3 === r2 || 0 === i3 && e2 === r2) return true;
          }
        ...
        if (null !== e2) {
          ...
          e2.setDepthDelta(o2);
        } else this.edgeList.add(t2), t2.setDepthDelta(Qi.depthDelta(t2.getLabel()));
        ...
        if (s2.size() <= 0) return this.createEmptyResultGeometry();
        ...
        if (u2.size() <= 0) return this.createEmptyResultGeometry();
        ...
        if (0 === arguments.length) for (var t2 = this.segStrings.iterator(); t2.hasNext(); ) {
          ...
          for (var i3 = arguments[0], r2 = arguments[1], t2 = r2.iterator(); t2.hasNext(); ) for (var e2 = t2.next(), n2 = e2.getCoordinates(), s2 = 1; s2 < n2.length - 1; s2++) if (n2[s2].equals(i3)) throw new l("found endpt/interior pt intersection at index " + s2 + " :pt " + i3);
        }
      }, checkInteriorIntersections: function() {
        if (0 === arguments.length) for (var t2 = this.segStrings.iterator(); t2.hasNext(); ) for (var e2 = t2.next(), n2 = this.segStrings.iterator(); n2.hasNext(); ) {
          var i3 = n2.next();
          this.checkInteriorIntersections(e2, i3);
        }
        else if (2 === arguments.length) for (var r2 = arguments[0], s2 = arguments[1], o2 = r2.getCoordinates(), a2 = s2.getCoordinates(), u2 = 0; u2 < o2.length - 1; u2++) for (var h2 = 0; h2 < a2.length - 1; h2++) this.checkInteriorIntersections(r2, u2, s2, h2);
        else if (4 === arguments.length) {
          var c2 = arguments[0], f2 = arguments[1], g2 = arguments[2], d2 = arguments[3];
          if (c2 === g2 && f2 === d2) return null;
          var p2 = c2.getCoordinates()[f2], v2 = c2.getCoordinates()[f2 + 1], m2 = g2.getCoordinates()[d2], y2 = g2.getCoordinates()[d2 + 1];
          if (this.li.computeIntersection(p2, v2, m2, y2), this.li.hasIntersection() && (this.li.isProper() || this.hasInteriorIntersection(this.li, p2, v2) || this.hasInteriorIntersection(this.li, m2, y2))) throw new l("found non-noded intersection at " + p2 + "-" + v2 + " and " + m2 + "-" + y2);
        }
      }, checkValid: function() {
        ...
        else if (1 === arguments.length) for (var n2 = arguments[0], i3 = n2.getCoordinates(), t2 = 0; t2 < i3.length - 2; t2++) this.checkCollapse(i3[t2], i3[t2 + 1], i3[t2 + 2]);
        ...
        if (t2.equals(n2)) throw new l("found non-noded collapse at " + Ji.fact.createLineString([t2, e2, n2]));
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        return Ji;
        ...
        if (this.li.computeIntersection(r2, s2, o2, a2), this.li.hasIntersection() && this.li.isInteriorIntersection()) {
          for (var u2 = 0; u2 < this.li.getIntersectionNum(); u2++) this.interiorIntersections.add(this.li.getIntersection(u2));
        ...
        else if (arguments[0] instanceof Ke) for (var i3 = arguments[0], r2 = i3.getCoordinates(), s2 = 0; s2 < r2.length; s2++) {
      ...
      e(or.prototype, { filter: function(t2) {
        ...
        if (0 === arguments.length) {
          var t2 = new Array(2).fill(null);
          if (this.computeContainmentDistance(0, t2), this.minDistance <= this.terminateDistance) return null;
          ...
          if (r2.size() > 0) {
            ...
            if (this.computeContainmentDistance(s2, r2, n2), this.minDistance <= this.terminateDistance) return this.minDistanceLocation[i3] = n2[0], this.minDistanceLocation[e2] = n2[1], null;
          }
        } else if (3 === arguments.length) {
          if (arguments[2] instanceof Array && R(arguments[0], y) && R(arguments[1], y)) {
            for (var o2 = arguments[0], a2 = arguments[1], u2 = arguments[2], l2 = 0; l2 < o2.size(); l2++) for (var h2 = o2.get(l2), c2 = 0; c2 < a2.size(); c2++) if (this.computeContainmentDistance(h2, a2.get(c2), u2), this.minDistance <= this.terminateDistance) return null;
            ...
            if (L.EXTERIOR !== this.ptLocator.locate(p2, g2)) return this.minDistance = 0, d2[0] = f2, d2[1] = new ar(g2, p2), null;
          }
        }
      }, computeMinDistanceLinesPoints: function(t2, e2, n2) {
        for (var i3 = 0; i3 < t2.size(); i3++) for (var r2 = t2.get(i3), s2 = 0; s2 < e2.size(); s2++) {
          var o2 = e2.get(s2);
          if (this.computeMinDistance(r2, o2, n2), this.minDistance <= this.terminateDistance) return null;
        }
        ...
        if (0 === arguments.length) {
          ...
          if (arguments[2] instanceof Array && arguments[0] instanceof St && arguments[1] instanceof Lt) {
            var t2 = arguments[0], e2 = arguments[1], n2 = arguments[2];
            if (t2.getEnvelopeInternal().distance(e2.getEnvelopeInternal()) > this.minDistance) return null;
            ...
            if (l2.getEnvelopeInternal().distance(h2.getEnvelopeInternal()) > this.minDistance) return null;
            for (var i3 = l2.getCoordinates(), f2 = h2.getCoordinates(), s2 = 0; s2 < i3.length - 1; s2++) for (var g2 = 0; g2 < f2.length - 1; g2++) {
        ...
        for (var i3 = 0; i3 < t2.size(); i3++) for (var r2 = t2.get(i3), s2 = 0; s2 < e2.size(); s2++) {
          ...
          if (a2 < this.minDistance && (this.minDistance = a2, n2[0] = new ar(r2, 0, r2.getCoordinate()), n2[1] = new ar(o2, 0, o2.getCoordinate())), this.minDistance <= this.terminateDistance) return null;
        }
      }, distance: function() {
        if (null === this.geom[0] || null === this.geom[1]) throw new i2("null geometries are not supported");
      ...
      e(cr.prototype, { getCoordinates: function() {
        ...
        for (var e2 = new I(), n2 = t2.iterator(); n2.hasNext(); ) e2.add(n2.next().parentEdge);
        return e2;
      ...
      h(Cr, gr), e(Cr.prototype, { getNext: function() {
        ...
        if (null !== this.holes) {
          ...
          for (var e2 = 0; e2 < this.holes.size(); e2++) t2[e2] = this.holes.get(e2);
        }
        ...
        for (var t2 = 0; t2 < this.deList.size(); t2++) {
          ...
          if (null !== n2 && n2.isIncludedSet()) return this.setIncluded(!n2.isIncluded()), null;
        }
      }, setShell: function(t2) {
        this.shell = t2;
        ...
        if (e2) for (var i3 = 0; i3 < t2.length; i3++) n2.add(t2[i3], false);
        else for (var i3 = t2.length - 1; i3 >= 0; i3--) n2.add(t2[i3], false);
        ...
        for (var e2 = t2.iterator(); e2.hasNext(); ) {
          ...
          if (null !== r2) for (var s2 = r2.iterator(); s2.hasNext(); ) {
            var o2 = s2.next();
            Rr.computeNextCCWEdges(o2, i3);
          }
        }
      }, deleteDangles: function() {
        for (var t2 = this.findNodesOfDegree(1), e2 = new J(), n2 = new pe(), i3 = t2.iterator(); i3.hasNext(); ) n2.push(i3.next());
        for (; !n2.isEmpty(); ) {
          var r2 = n2.pop();
      ...
      e(br.prototype, { createEdgeEndForNext: function(t2, e2, n2, i3) {
        ...
        if (r2 >= t2.getNumPoints() && null === i3) return null;
        ...
        for (var n2 = this.iterator(); n2.hasNext(); ) {
          ...
          if (i3.getLabel().isArea()) {
            ...
            if (r2 === L.INTERIOR) return this.label.setLocation(t2, e2, L.INTERIOR), null;
        ...
        for (var r2 = 0; 2 > r2; r2++) this.computeLabelOn(r2, t2), e2 && this.computeLabelSides(r2);
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        return Or;
        ...
        } else t2.getLabel().setAllLocations(e2, L.EXTERIOR);
      }, computeIM: function() {
        var t2 = new fe();
        if (t2.set(L.EXTERIOR, L.EXTERIOR, 2), !this.arg[0].getGeometry().getEnvelopeInternal().intersects(this.arg[1].getGeometry().getEnvelopeInternal())) return this.computeDisjointIM(t2), t2;
        ...
        for (var e2 = this.arg[t2].getEdgeIterator(); e2.hasNext(); ) for (var n2 = e2.next(), i3 = n2.getLabel().getLocation(t2), r2 = n2.getEdgeIntersectionList().iterator(); r2.hasNext(); ) {
        ...
        if (t2 instanceof Tt) return false;
        if (t2 instanceof Lt) return this.isPointContainedInBoundary(t2);
        if (t2 instanceof St) return this.isLineStringContainedInBoundary(t2);
        for (var e2 = 0; e2 < t2.getNumGeometries(); e2++) {
          var n2 = t2.getGeometryN(e2);
        ...
        if (t2.x === e2.x) {
          if (t2.x === this.rectEnv.getMinX() || t2.x === this.rectEnv.getMaxX()) return true;
        } else if (t2.y === e2.y && (t2.y === this.rectEnv.getMinY() || t2.y === this.rectEnv.getMaxY())) return true;
        return false;
      }, isLineStringContainedInBoundary: function(t2) {
        for (var e2 = t2.getCoordinateSequence(), n2 = new g(), i3 = new g(), r2 = 0; r2 < e2.size() - 1; r2++) if (e2.getCoordinate(r2, n2), e2.getCoordinate(r2 + 1, i3), !this.isLineSegmentContainedInBoundary(n2, i3)) return false;
        return true;
        ...
        var n2 = new C(t2, e2);
        if (!this.rectEnv.intersects(n2)) return false;
        if (this.rectEnv.intersects(t2)) return true;
        if (this.rectEnv.intersects(e2)) return true;
        ...
        for (var e2 = 0; e2 < t2.getNumGeometries() && !this._isDone; e2++) {
          var n2 = t2.getGeometryN(e2);
          if (n2 instanceof ft) this.applyTo(n2);
        ...
        if (!this.rectEnv.intersects(t2.getEnvelopeInternal())) return false;
        ...
        if (!(t2 instanceof Tt)) return null;
        var e2 = t2.getEnvelopeInternal();
        if (!this.rectEnv.intersects(e2)) return null;
        for (var n2 = new g(), i3 = 0; 4 > i3; i3++) if (this.rectSeq.getCoordinate(i3, n2), e2.contains(n2) && Tn.containsPointInPolygon(n2, t2)) return this._containsPoint = true, null;
        ...
        for (var e2 = t2.iterator(); e2.hasNext(); ) {
          var n2 = e2.next();
          if (this.checkIntersectionWithSegments(n2), this.hasIntersection) return null;
        }
      }, checkIntersectionWithSegments: function(t2) {
        for (var e2 = t2.getCoordinateSequence(), n2 = 1; n2 < e2.size(); n2++) if (e2.getCoordinate(n2 - 1, this.p0), e2.getCoordinate(n2, this.p1), this.rectIntersector.intersects(this.p0, this.p1)) return this.hasIntersection = true, null;
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        return kr;
      ...
      e(Ur.prototype, { extractElements: function(t2, e2) {
        ...
        if (0 === e2.size()) return this.otherGeom;
        ...
        if (3 === arguments.length) {
          ...
          if (i3 - n2 === 2) return this.unionSafe(Wr.getGeometry(e2, n2), Wr.getGeometry(e2, n2 + 1));
      ...
      e(Kr.prototype, { visitInteriorRing: function(t2, e2) {
        ...
        if (t2 instanceof Ot) for (var i3 = t2, r2 = 0; r2 < i3.getNumGeometries(); r2++) {
        ...
        for (var e2 = 0; e2 < t2.size(); e2++) {
          ...
          if (!n2.isHole()) {
            ...
            if (r2.getLabel().getLocation(0, cn.RIGHT) === L.INTERIOR) {
              for (var s2 = 0; s2 < i3.size(); s2++) if (r2 = i3.get(s2), !r2.isVisited()) return this.disconnectedRingcoord = r2.getCoordinate(), true;
            }
          }
        }
        return false;
        ...
        for (var n2 = 0; n2 < t2.length; n2++) if (!t2[n2].equals(e2)) return t2[n2];
        return null;
      }, e(Zr.prototype, { hasChildren: function() {
        for (var t2 = 0; 2 > t2; t2++) if (null !== this.subnode[t2]) return true;
        return false;
      }, isPrunable: function() {
        return !(this.hasChildren() || this.hasItems());
      }, addAllItems: function(t2) {
        t2.addAll(this.items);
        for (var e2 = 0; 2 > e2; e2++) null !== this.subnode[e2] && this.subnode[e2].addAllItems(t2);
        return t2;
      }, size: function() {
        for (var t2 = 0, e2 = 0; 2 > e2; e2++) null !== this.subnode[e2] && (t2 += this.subnode[e2].size());
        return t2 + this.items.size();
      }, addAllItemsFromOverlapping: function(t2, e2) {
        ...
        if (!this.isSearchMatch(t2)) return false;
        for (var n2 = false, i3 = 0; 2 > i3; i3++) if (null !== this.subnode[i3] && (n2 = this.subnode[i3].remove(t2, e2))) {
          this.subnode[i3].isPrunable() && (this.subnode[i3] = null);
          break;
        }
        return n2 ? n2 : n2 = this.items.remove(e2);
        ...
        for (var t2 = 0, e2 = 0; 2 > e2; e2++) if (null !== this.subnode[e2]) {
          var n2 = this.subnode[e2].depth();
          n2 > t2 && (t2 = n2);
        }
        return t2 + 1;
      }, nodeSize: function() {
        for (var t2 = 0, e2 = 0; 2 > e2; e2++) null !== this.subnode[e2] && (t2 += this.subnode[e2].nodeSize());
        return t2 + 1;
      }, add: function(t2) {
        this.items.add(t2);
      }, interfaces_: function() {
        ...
        for (this.level = Jr.computeLevel(t2), this.interval = new Qr(), this.computeInterval(this.level, t2); !this.interval.contains(t2); ) this.level += 1, this.computeInterval(this.level, t2);
        ...
        for (var n2 = t2.getEdgeIterator(); n2.hasNext(); ) for (var i3 = n2.next(), r2 = i3.getLabel().getLocation(e2), s2 = i3.getEdgeIntersectionList().iterator(); s2.hasNext(); ) {
        ...
        for (var t2 = this.nodeGraph.getNodeIterator(); t2.hasNext(); ) {
          var e2 = t2.next();
          if (!e2.getEdges().isAreaLabelsConsistent(this.geomGraph)) return this.invalidPoint = e2.getCoordinate().copy(), false;
        }
        return true;
      }, getInvalidPoint: function() {
        return this.invalidPoint;
      }, hasDuplicateRings: function() {
        for (var t2 = this.nodeGraph.getNodeIterator(); t2.hasNext(); ) for (var e2 = t2.next(), n2 = e2.getEdges().iterator(); n2.hasNext(); ) {
          var i3 = n2.next();
          if (i3.getEdgeEnds().size() > 1) return this.invalidPoint = i3.getEdge().getCoordinate(0), true;
        }
        return false;
        ...
        this.buildIndex();
        for (var t2 = 0; t2 < this.rings.size(); t2++) for (var e2 = this.rings.get(t2), n2 = e2.getCoordinates(), i3 = this.index.query(e2.getEnvelopeInternal()), r2 = 0; r2 < i3.size(); r2++) {
          ...
          if (e2 !== s2 && e2.getEnvelopeInternal().intersects(s2.getEnvelopeInternal())) {
            ...
            if (null !== a2) {
              ...
              if (u2) return this.nestedPt = a2, false;
            }
          }
        }
        return true;
        ...
        if (arguments[0] instanceof Array) {
          for (var t2 = arguments[0], e2 = 0; e2 < t2.length; e2++) if (!ls.isValid(t2[e2])) return this.validErr = new us(us.INVALID_COORDINATE, t2[e2]), null;
        } else if (arguments[0] instanceof Tt) {
          var n2 = arguments[0];
          if (this.checkInvalidCoordinates(n2.getExteriorRing().getCoordinates()), null !== this.validErr) return null;
          for (var e2 = 0; e2 < n2.getNumInteriorRing(); e2++) if (this.checkInvalidCoordinates(n2.getInteriorRingN(e2).getCoordinates()), null !== this.validErr) return null;
        }
        ...
        for (var e2 = t2.getEdgeIterator(); e2.hasNext(); ) {
          var n2 = e2.next();
          if (this.checkNoSelfIntersectingRing(n2.getEdgeIntersectionList()), null !== this.validErr) return null;
        }
        ...
        for (var e2 = new at(), n2 = true, i3 = t2.iterator(); i3.hasNext(); ) {
          ...
          if (n2) n2 = false;
            ...
            if (e2.contains(r2.coord)) return this.validErr = new us(us.RING_SELF_INTERSECTION, r2.coord), null;
            e2.add(r2.coord);
          }
        }
        ...
        for (var n2 = t2.getExteriorRing(), i3 = new is(n2), r2 = 0; r2 < t2.getNumInteriorRing(); r2++) {
          ...
          if (a2) return this.validErr = new us(us.HOLE_OUTSIDE_SHELL, o2), null;
        }
        ...
        if (arguments[0] instanceof Lt) {
          ...
          var n2 = arguments[0];
          if (this.checkInvalidCoordinates(n2.getCoordinates()), null !== this.validErr) return null;
          if (this.checkClosedRing(n2), null !== this.validErr) return null;
          var i3 = new $n(0, n2);
          if (this.checkTooFewPoints(i3), null !== this.validErr) return null;
          var r2 = new ae();
          i3.computeSelfNodes(r2, true, true), this.checkNoSelfIntersectingRings(i3);
        } else if (arguments[0] instanceof St) {
          var s2 = arguments[0];
          if (this.checkInvalidCoordinates(s2.getCoordinates()), null !== this.validErr) return null;
          var i3 = new $n(0, s2);
          this.checkTooFewPoints(i3);
        } else if (arguments[0] instanceof Tt) {
          var o2 = arguments[0];
          if (this.checkInvalidCoordinates(o2), null !== this.validErr) return null;
          if (this.checkClosedRings(o2), null !== this.validErr) return null;
          var i3 = new $n(0, o2);
          if (this.checkTooFewPoints(i3), null !== this.validErr) return null;
          if (this.checkConsistentArea(i3), null !== this.validErr) return null;
          if (!this.isSelfTouchingRingFormingHoleValid && (this.checkNoSelfIntersectingRings(i3), null !== this.validErr)) return null;
          if (this.checkHolesInShell(o2, i3), null !== this.validErr) return null;
          if (this.checkHolesNotNested(o2, i3), null !== this.validErr) return null;
          ...
          for (var a2 = arguments[0], u2 = 0; u2 < a2.getNumGeometries(); u2++) {
            ...
            if (this.checkInvalidCoordinates(l2), null !== this.validErr) return null;
            if (this.checkClosedRings(l2), null !== this.validErr) return null;
          }
          var i3 = new $n(0, a2);
          if (this.checkTooFewPoints(i3), null !== this.validErr) return null;
          if (this.checkConsistentArea(i3), null !== this.validErr) return null;
          ...
          for (var u2 = 0; u2 < a2.getNumGeometries(); u2++) {
            var l2 = a2.getGeometryN(u2);
            if (this.checkHolesInShell(l2, i3), null !== this.validErr) return null;
          }
          for (var u2 = 0; u2 < a2.getNumGeometries(); u2++) {
            var l2 = a2.getGeometryN(u2);
            if (this.checkHolesNotNested(l2, i3), null !== this.validErr) return null;
          }
          if (this.checkShellsNotNested(a2, i3), null !== this.validErr) return null;
          this.checkConnectedInteriors(i3);
        } else if (arguments[0] instanceof ft) for (var h2 = arguments[0], u2 = 0; u2 < h2.getNumGeometries(); u2++) {
          var c2 = h2.getGeometryN(u2);
          if (this.checkValid(c2), null !== this.validErr) return null;
        }
        else if (arguments[0] instanceof B) {
          var f2 = arguments[0];
          if (this.validErr = null, f2.isEmpty()) return null;
          if (f2 instanceof Lt) this.checkValid(f2);
          else if (f2 instanceof Pt) this.checkValid(f2);
          else if (f2 instanceof bt) this.checkValid(f2);
          else if (f2 instanceof St) this.checkValid(f2);
          else if (f2 instanceof Tt) this.checkValid(f2);
          else if (f2 instanceof Ot) this.checkValid(f2);
          else {
            if (!(f2 instanceof ft)) throw new UnsupportedOperationException(f2.getClass().getName());
            this.checkValid(f2);
          }
        }
        ...
        if (!a2) return null;
        if (e2.getNumInteriorRing() <= 0) return this.validErr = new us(us.NESTED_SHELLS, o2), null;
        for (var u2 = null, l2 = 0; l2 < e2.getNumInteriorRing(); l2++) {
          var h2 = e2.getInteriorRingN(l2);
          if (u2 = this.checkShellInsideHole(t2, h2, n2), null === u2) return null;
        }
        this.validErr = new us(us.NESTED_SHELLS, u2);
      }, checkClosedRings: function(t2) {
        if (this.checkClosedRing(t2.getExteriorRing()), null !== this.validErr) return null;
        for (var e2 = 0; e2 < t2.getNumInteriorRing(); e2++) if (this.checkClosedRing(t2.getInteriorRingN(e2)), null !== this.validErr) return null;
        ...
        for (var n2 = 0; n2 < t2.getNumGeometries(); n2++) for (var i3 = t2.getGeometryN(n2), r2 = i3.getExteriorRing(), s2 = 0; s2 < t2.getNumGeometries(); s2++) if (n2 !== s2) {
          var o2 = t2.getGeometryN(s2);
          if (this.checkShellNotNested(r2, o2, e2), null !== this.validErr) return null;
        }
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        ...
        for (var i3 = n2.findEdge(e2), r2 = i3.getEdgeIntersectionList(), s2 = 0; s2 < t2.length; s2++) {
          var o2 = t2[s2];
          if (!r2.isIntersection(o2)) return o2;
        }
        return null;
      }, ls.isValid = function() {
        if (arguments[0] instanceof B) {
      ...
      h(hs, _t.CoordinateOperation), e(hs.prototype, { editCoordinates: function(t2, e2) {
        ...
        if (t2.getPrecisionModel() === e2) return new _t();
      ...
      e(fs.prototype, { simplifySection: function(t2, e2) {
        ...
        if (n2 <= this.distanceTolerance) for (var r2 = t2 + 1; e2 > r2; r2++) this.usePt[r2] = false;
        else this.simplifySection(t2, i3), this.simplifySection(i3, e2);
      }, setDistanceTolerance: function(t2) {
        this.distanceTolerance = t2;
      }, simplify: function() {
        this.usePt = new Array(this.pts.length).fill(null);
        for (var t2 = 0; t2 < this.pts.length; t2++) this.usePt[t2] = true;
        this.simplifySection(0, this.pts.length - 1);
        for (var e2 = new N(), t2 = 0; t2 < this.pts.length; t2++) this.usePt[t2] && e2.add(new g(this.pts[t2]));
        return e2.toCoordinateArray();
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        ...
        if (0 > t2) throw new i2("Tolerance must be non-negative");
        this.distanceTolerance = t2;
      }, interfaces_: function() {
        return [];
      }, getClass: function() {
        ...
        for (var e2 = new Array(t2.size() + 1).fill(null), n2 = null, i3 = 0; i3 < t2.size(); i3++) n2 = t2.get(i3), e2[i3] = n2.p0;
        return e2[e2.length - 1] = n2.p1, e2;
      }, e(ms.prototype, { remove: function(t2) {
        this.index.remove(new C(t2.p0, t2.p1), t2);
      }, add: function() {
        if (arguments[0] instanceof vs) for (var t2 = arguments[0], e2 = t2.getSegments(), n2 = 0; n2 < e2.length; n2++) {
          var i3 = e2[n2];
          this.add(i3);
        }
        else if (arguments[0] instanceof ce) {
        ...
        for (var e2 = this.outputIndex.query(t2), n2 = e2.iterator(); n2.hasNext(); ) {
          var i3 = n2.next();
          if (this.hasInteriorIntersection(i3, t2)) return true;
        }
        return false;
        ...
        for (var i3 = this.inputIndex.query(n2), r2 = i3.iterator(); r2.hasNext(); ) {
          ...
          if (this.hasInteriorIntersection(s2, n2)) {
            if (xs.isInLineSection(t2, e2, s2)) continue;
            return true;
          }
        }
        return false;
        ...
        for (var e2 = t2.iterator(); e2.hasNext(); ) this.inputIndex.add(e2.next());
        for (var e2 = t2.iterator(); e2.hasNext(); ) {
      ...
      e(Ss.prototype, { splitAt: function() {
        if (1 === arguments.length) {
          ...
          if (t2.distance(this.seg.p0) < this.minimumLen) return this.splitPt = this.seg.pointAlong(e2), null;
          if (t2.distance(this.seg.p1) < this.minimumLen) return this.splitPt = Ss.pointAlongReverse(this.seg, e2), null;
          this.splitPt = t2;
        } else if (2 === arguments.length) {
        ...
        if (this.subdiv.isVertexOfEdge(e2, t2)) return e2;
        ...
        for (; ; ) {
          var r2 = e2.oPrev();
          if (r2.dest().rightOf(e2) && t2.isInCircle(e2.orig(), r2.dest(), e2.dest())) bs.swap(e2), e2 = e2.oPrev();
          else {
            if (e2.oNext() === i3) return n2;
            e2 = e2.oNext().lPrev();
          }
        }
        ...
        if (this.isFrameVertex(i3)) return true;
        ...
        for (var n2 = 0, i3 = this.quadEdges.size(), r2 = e2; ; ) {
          if (n2++, n2 > i3) throw new Ds(r2.toLineSegment());
          if (t2.equals(r2.orig()) || t2.equals(r2.dest())) break;
          if (t2.rightOf(r2)) r2 = r2.sym();
          else if (t2.rightOf(r2.oNext())) {
            if (t2.rightOf(r2.dPrev())) break;
            r2 = r2.dPrev();
          } else r2 = r2.oNext();
        }
        return r2;
        ...
        if (t2.equals(e2.orig(), this.tolerance) || t2.equals(e2.dest(), this.tolerance)) return e2;
        ...
        if (1 === arguments.length) {
          ...
          var o2 = s2;
          do {
            if (o2.dest().getCoordinate().equals2D(i3)) return o2;
            o2 = o2.oNext();
          } while (o2 !== s2);
          return null;
        }
        ...
        if (e2[0] = t2, e2[1] = e2[0].lNext(), e2[2] = e2[1].lNext(), e2[2].lNext() !== e2[0]) throw new i2("Edges do not form a triangle");
      }, e(Gs.prototype, { visit: function(t2) {
        for (var e2 = t2[0].orig().getCoordinate(), n2 = t2[1].orig().getCoordinate(), i3 = t2[2].orig().getCoordinate(), r2 = ci.circumcentre(e2, n2, i3), s2 = new Ts(r2), o2 = 0; 3 > o2; o2++) t2[o2].rot().setOrig(s2);
      }, interfaces_: function() {
        return [As];
      }, getClass: function() {
        return Gs;
        ...
        if (2 === arguments.length) {
          var e2 = arguments[0], n2 = arguments[1];
          if (null === this.root) return this.root = new Ys(e2, n2), this.root;
          if (this.tolerance > 0) {
            var i3 = this.findBestMatchNode(e2);
            if (null !== i3) return i3.increment(), i3;
          }
        ...
        if (2 === arguments.length) {
          for (var e2 = arguments[0], n2 = arguments[1], i3 = new N(), r2 = e2.iterator(); r2.hasNext(); ) for (var s2 = r2.next(), o2 = n2 ? s2.getCount() : 1, a2 = 0; o2 > a2; a2++) i3.add(s2.getCoordinate(), true);
        ...
        if (2 === arguments.length) for (var s2 = arguments[0], o2 = arguments[1], a2 = s2.getCoordinates(), i3 = 1; i3 < a2.length; i3++) o2.add(new Vs(a2[i3 - 1], a2[i3]));
      ...
      e(Zs.prototype, { interfaces_: function() {
        ...
        if (t2.isEmpty() || e2.isEmpty()) {
          if (t2.isEmpty() && e2.isEmpty()) return ii.createEmptyResult(ii.UNION, t2, e2, t2.getFactory());
          if (t2.isEmpty()) return e2.copy();
          if (e2.isEmpty()) return t2.copy();
        }
        ...
        if (this.isEmpty() || t2.isEmpty()) return ii.createEmptyResult(ii.INTERSECTION, this, t2, this.factory);
        ...
        for (var t2 = arguments.length, e2 = Array(t2), n2 = 0; t2 > n2; n2++) e2[n2] = arguments[n2];
        ...
        if (this.isEmpty() || t2.isEmpty()) {
          if (this.isEmpty() && t2.isEmpty()) return ii.createEmptyResult(ii.SYMDIFFERENCE, this, t2, this.factory);
          if (this.isEmpty()) return t2.copy();
          if (t2.isEmpty()) return this.copy();
        }
...
var require_turf_difference = __commonJS({
  "node_modules/turf-difference/index.js"(exports, module) {
    ...
    module.exports = function(p1, p2) {
      ...
      if (differenced.isEmpty()) return void 0;
      var writer = new jsts.io.GeoJSONWriter();
...
var require_spline = __commonJS({
  "node_modules/turf-bezier/spline.js"(exports, module) {
    var Spline = function(options) {
      ...
      this.delay = 0;
      for (var i2 = 0; i2 < this.length; i2++) this.points[i2].z = this.points[i2].z || 0;
    ...
    function flattenCoords(data) {
      ...
      for (var i2 = 0; i2 < data.length; i2++) {
        for (var j = 0; j < data[i2].length; j++) {
          for (var d = 0; d < dim; d++) result.vertices.push(data[i2][j][d]);
        }
        if (i2 > 0) {
  ...
  "node_modules/turf-along/index.js"(exports, module) {
    ...
    module.exports = function(line, distance, units) {
      ...
      for (var i2 = 0; i2 < coords.length; i2++) {
        if (distance >= travelled && i2 === coords.length - 1) break;
        else if (travelled >= distance) {
          var overshot = distance - travelled;
          if (!overshot) return point(coords[i2]);
          else {
